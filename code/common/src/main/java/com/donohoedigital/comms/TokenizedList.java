...
public class TokenizedList implements DataMarshal {
    ...
    /**
     * Create a new TokenizedList from a string, previously generated by write(). If
     * nReadNumTokens is TOKEN_READ_ALL, then all tokens are read. Otherwise, up to
     * nReadTokens is read.
     */
    ...
    /**
     * Finish parsing any remaining tokens from the data stream created by the above
     * constructor
     */
    ...
    private Object nextToken(Class<?> cExpected) {
        ...
        if (o == null)
            return null;
        ApplicationError.assertTrue(cExpected.isAssignableFrom(o.getClass()), "Next token wrong type",
                o.getClass().getName());
        return o;
    }
    ...
    /**
     * Class to escape special chars in given value. Escapes special values used by
     * TokenizedList, NameValueToken and DataMarshaller
     */
