...
/**
 * This array list is marshallable and can marshal the following contents:
 * String, Integer, Double, Boolean and anything that implements DataMarshal
 *
 * @author donohoe
 */
@DataCoder('a')
    ...
    public String marshal(MsgState state) {
        ...
        for (int i = 0; i < size(); i++) {
            ...
            if (oValue == null) {
                ...
                logger.debug("Warning: skipping unsupported array entry #" + i + " class is "
                        + (oValue != null ? oValue.getClass().getName() : "null"));
            }
        }
