...
public class DDMessenger {
     ...
     * exceptions and returns message with CAT_ERROR or CAT_APPL_ERROR. If listener
    ...
    public DDMessage sendMessage(URL url, DDMessage send, DDMessageListener listener) {
        ...
        // error handling closely linked to SendMessageDialog.java
            ...
            if (e instanceof ApplicationError) {
                ...
                if (ae2.getErrorCode() == ErrorCodes.ERROR_404 || ae2.getErrorCode() == ErrorCodes.ERROR_403
    ...
    /**
     * Connect to site and get content of the given URL. If writer is not null,
     * initiate the request using POST method, calling writer.write() to write the
     * data and sPostContentType as the content-type.
     */
    public ReturnData getURL(String sURL, PostWriter writer, String sPostContentType, PostReader reader,
     ...
     * Connect to site and get content of the given URL. If writer is not null,
     * initiate the request using POST method, calling writer.write() to write the
     * data and sPostContentType as the content-type. If reader is non-null, data is
     * expected to be read using the reader. Return Data will contain no data, but
     * will contain content-type and length;
     */
    public ReturnData getURL(URL url, PostWriter writer, String sPostContentType, PostReader reader,
            DDMessageListener listener, DDHttpClient.HttpOptions options) {
        ...
        try {
            ...
            if (listener != null)
                listener.updateStep(DDMessageListener.STEP_DONE);
    ...
    public static class ReturnData {
        ...
        private ReturnData(DDByteArrayOutputStream headers, DDByteArrayOutputStream out, String sContentType,
                int nResponseCode) {
