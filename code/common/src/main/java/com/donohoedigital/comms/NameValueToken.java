...
public class NameValueToken implements DataMarshal {
    ...
    public static void loadNameValueTokensIntoList(TokenizedList entry, AbstractMap<String, Object> info) {
        ...
        while (iter.hasNext()) {
            ...
            if (oValue == null) {
                ...
                logger.debug("Warning: skipping unsupported map entry '" + sName + "' class is "
    ...
    /**
     * load remaining entries in a TokenizedList into the given hashmap - all
     * remaining entries are assumed to be NameValueTokens
     */
