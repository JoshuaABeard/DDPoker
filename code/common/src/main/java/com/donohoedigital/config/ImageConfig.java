...
/**
 * Loads image.xml files in the module directories defined by the appconfig.xml
 * file.
 *
 * @author donohoe
 */
public class ImageConfig extends XMLConfigFileLoader {
    ...
    public static Cursor createCursor(String sName) {
        ...
        return tk.createCustomCursor(image.getBufferedImage(), new Point(image.getX(), image.getY()), sName);
    }
    ...
    /**
     * Return BufferedImage file for request image. If bReportMissing is true, log
     * message if image not found
     */
