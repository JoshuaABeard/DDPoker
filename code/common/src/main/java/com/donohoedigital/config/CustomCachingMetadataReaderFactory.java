...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Nov 6, 2008 Time: 12:40:35 PM
...
class CustomCachingMetadataReaderFactory extends SimpleMetadataReaderFactory {
     ...
     *            the Spring ResourceLoader to use (also determines the ClassLoader
     *            to use)
     */
    ...
    /**
     * Override to (a) get MetadataReader wrapped in CachingMetadataReader and (b)
     * cache it
     *
     * @param resource
     * @return
