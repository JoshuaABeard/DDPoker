...
public class XMLWriter extends PrintWriter {
    ...
    /**
     * Create new writer for f. If bBackup passed, file is saved to filename +
     * ".bak". If not, file is overwritten
     */
    public static XMLWriter CreateXMLWriter(File f, boolean bBackup) throws ApplicationError {
        if (bBackup) {
    ...
    /**
     * print closing element "&gt;" - use printElementEnd(sElementName) to print
    ...
    /**
     * print closing element "&gt;" with newline - use printElementEnd(sElementName)
     * to print matching closing tag
     */
    ...
    /**
     * Print element on line w/ nIndent spaces before it and a newline after
     */
    public void printElementLine(String sElementName, Object value, int nIndent) {
        printIndent(nIndent);
