...
/**
 * Preferences facade that delegates to FilePrefs (file-based JSON
 * configuration). Maintains backward compatibility with existing code that uses
...
public class Prefs {
    ...
    /**
     * Set root node name - overrides default of ConfigManager.getAppName(); only
     * sets if ROOT is null.
     */
    ...
    private static String getRootNodeName() {
        ...
        // ApplicationError.assertNotNull(ConfigManager.getAppConfig(), "AppConfig is
        // null");
