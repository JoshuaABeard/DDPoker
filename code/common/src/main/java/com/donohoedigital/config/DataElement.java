...
public class DataElement {
    ...
    /**
     * Get string value used to represent the "notselected" value when displaying
     * this list in a combobox or similar. Equals "0notselected", which is used to
     * lookup display value for not-selected choice. Zero in front to sort properly
     */
