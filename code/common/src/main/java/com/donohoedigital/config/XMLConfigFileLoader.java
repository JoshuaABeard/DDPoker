...
public class XMLConfigFileLoader implements ErrorHandler {
     ...
     * http://apache.org/xml/properties/schema/external-schemaLocation. If
     * sNameSpace is null, then parser configured to use
    ...
    public Document loadXMLUrl(URL url, String sNameSpace, String sValidationSchema, String sAppName, String sModule) {
        ...
        if (nError_ > 0 || nFatal_ > 0 || jde != null || e != null) {
            ...
            if (nError_ == 0 && nFatal_ == 0) {
                if (e != null)
                    throw new ApplicationError(ErrorCodes.ERROR_CODE_ERROR, e);
                else
                    throw new ApplicationError(ErrorCodes.ERROR_JDOM_PARSE_FAILED, jde.getMessage(), "");
            }
    ...
    private SAXBuilder createParser(String sNameSpace, String sValidationSchema, String sAppName, String sModule) {
        ...
        // If validation schema passed in, set it. This is used to ensure correct schema
        // is
     ...
     */
    public static String[] getChildStringArray(Element parent, String sChildName, Namespace ns, boolean bRequired,
            String sErrLocation) {
     ...
     */
    public static Boolean[] getChildBooleanArray(Element parent, String sChildName, Namespace ns, boolean bRequired,
            String sErrLocation) {
        List<Element> children = getChildren(parent, sChildName, ns, bRequired, sErrLocation);
        int nSize = children.size();
        if (nSize == 0)
        ...
        for (int i = 0; i < nSize; i++) {
            ...
            if (value == null) {
                throw new ApplicationError(ErrorCodes.ERROR_VALIDATION,
                        ...
                        "Value=" + sValue, "Make sure value is an boolean (true/1 or false/0) at " + sErrLocation);
            }
            values[i] = value;
        }
        return values;
     ...
     */
    public static Integer[] getChildIntegerArray(Element parent, String sChildName, Namespace ns, boolean bRequired,
            String sErrLocation) {
        List<Element> children = getChildren(parent, sChildName, ns, bRequired, sErrLocation);
        int nSize = children.size();
        if (nSize == 0)
        ...
        for (int i = 0; i < nSize; i++) {
            try {
                ...
                throw new ApplicationError(ErrorCodes.ERROR_VALIDATION,
                        ...
                        "Value=" + sValue, "Make sure value is an integer at " + sErrLocation);
            }
        }
        return values;
    }
     ...
     */
    public static Double[] getChildDoubleArray(Element parent, String sChildName, Namespace ns, boolean bRequired,
            String sErrLocation) {
        List<Element> children = getChildren(parent, sChildName, ns, bRequired, sErrLocation);
        int nSize = children.size();
        if (nSize == 0)
        ...
        for (int i = 0; i < nSize; i++) {
            try {
                ...
                throw new ApplicationError(ErrorCodes.ERROR_VALIDATION,
                        ...
                        "Value=" + sValue, "Make sure value is an double at " + sErrLocation);
            }
        }
        return values;
    }
     ...
     */
    public static Integer[] getChildAttributeIntegerArray(Element parent, String sChildName, String sAttrName,
        ...
        for (int i = 0; i < nSize; i++) {
            try {
                values[i] = getIntegerAttributeValue((children.get(i)), sAttrName, bRequired,
                        sErrLocation + " (" + sChildName + " #" + i + ")");
            } catch (NumberFormatException ne) {
                throw new ApplicationError(ErrorCodes.ERROR_VALIDATION,
                        "Element " + sChildName + " #" + i + " does not contain a valid integer value in "
                                + parent.getName(),
                        "Value=" + sValue, "Make sure value is an integer at " + sErrLocation);
            }
        }
     ...
     */
    public static Boolean getBooleanAttributeValue(Element element, String sAttrName, boolean bRequired,
            String sErrLocation, Boolean bDefault) {
        ...
        if (bRequired && sValue == null) {
            throw new ApplicationError(ErrorCodes.ERROR_NOT_FOUND,
                    getErrorMessage(sAttrName, "attribute", element.getName(), sErrLocation), null);
        }
        ...
        if (value == null) {
            throw new ApplicationError(ErrorCodes.ERROR_VALIDATION,
                    "Attribute " + sAttrName + " does not contain a valid boolean value.", "Value=" + sValue,
     ...
     */
    public static Integer getIntegerAttributeValue(Element element, String sAttrName, boolean bRequired,
            String sErrLocation, Integer nDefault) {
        String sValue = element.getAttributeValue(sAttrName);
        ...
        try {
            ...
            throw new ApplicationError(ErrorCodes.ERROR_VALIDATION,
                    "Attribute " + sAttrName + " does not contain a valid integer value.", "Value=" + sValue,
     ...
     */
    public static Double getDoubleAttributeValue(Element element, String sAttrName, boolean bRequired,
            String sErrLocation, Double dDefault) {
        String sValue = element.getAttributeValue(sAttrName);
        ...
        try {
            ...
            throw new ApplicationError(ErrorCodes.ERROR_VALIDATION,
                    "Attribute " + sAttrName + " does not contain a valid double value.", "Value=" + sValue,
     ...
     */
    public static String getStringAttributeValue(Element element, String sAttrName, boolean bRequired,
            String sErrLocation, String sDefault) {
        String sValue = element.getAttributeValue(sAttrName);
     ...
     */
    public static Boolean getChildBooleanValue(Element element, String sChildName, Namespace ns, boolean bRequired,
            String sErrLocation, Boolean bDefault) {
        String sValue = element.getChildTextTrim(sChildName, ns);

        if (bRequired && sValue == null) {
            throw new ApplicationError(ErrorCodes.ERROR_NOT_FOUND,
                    getErrorMessage(sChildName, "element", element.getName(), sErrLocation), null);
        }
        ...
        if (value == null) {
            throw new ApplicationError(ErrorCodes.ERROR_VALIDATION,
                    "Element " + sChildName + " does not contain a valid boolean value.", "Value=" + sValue,
                    "Make sure value is 0, 1, true or false");
        }
        return value;
    }
     ...
     */
    public static Integer getChildIntegerValue(Element element, String sChildName, Namespace ns, boolean bRequired,
            String sErrLocation, Integer nDefault) {
        String sValue = element.getChildTextTrim(sChildName, ns);
        ...
        try {
            ...
            throw new ApplicationError(ErrorCodes.ERROR_VALIDATION,
                    "Element " + sChildName + " does not contain a valid integer value.", "Value=" + sValue,
     ...
     */
    public static Double getChildDoubleValue(Element element, String sChildName, Namespace ns, boolean bRequired,
            String sErrLocation, Double dDefault) {
        String sValue = element.getChildTextTrim(sChildName, ns);
        ...
        try {
            ...
            throw new ApplicationError(ErrorCodes.ERROR_VALIDATION,
                    "Element " + sChildName + " does not contain a valid double value.", "Value=" + sValue,
     ...
     */
    public static String getChildStringValueTrimmed(Element element, String sChildName, Namespace ns, boolean bRequired,
            String sErrLocation, String sDefault) {
        String sValue = element.getChildTextTrim(sChildName, ns);
     ...
     */
    protected static Element getChild(Element element, String sChildName, Namespace ns, boolean bRequired,
            String sErrLocation) {
     ...
     */
    public static List<Element> getChildren(Element element, String sChildName, Namespace ns, boolean bRequired,
            String sErrLocation) {
        // always returns non-null (if none, size=0)
        ...
        if (bRequired && children.size() <= 0) {
            throw new ApplicationError(ErrorCodes.ERROR_NOT_FOUND,
                    getErrorMessage(sChildName, "element(s)", element.getName(), sErrLocation), null);
        }
     ...
     * TypedHashMap
     */
    public static void loadParams(Element element, Namespace ns, TypedHashMap map, boolean bParamRequired,
            boolean bParamListRequired, String sErrLocation) {
        ...
        // <paramlist>
        List<Element> paramlist = XMLConfigFileLoader.getChildren(element, "paramlist", ns, bParamListRequired,
                sErrLocation);
    ...
    private static String getErrorMessage(String sName, String sType, String sElementName, String sErrLocation) {
        String sLocation = "";
        if (sErrLocation != null)
            sLocation = " in " + sErrLocation;
