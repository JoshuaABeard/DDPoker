...
/**
 * This class is used to make hashtable access easier (less casting by caller).
 * You will get class cast exceptions if object you are retrieving doesn't match
 * what is expected.
 */
public class TypedHashMap extends TreeMap<String, Object> {
    ...
    /**
     * return an integer param, nDefault if not found, bounds are checked (min/max)
     */
