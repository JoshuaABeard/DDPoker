...
/**
 * This class is used to represent an application error condition. It contains
 * the error description, details, and a suggested solution. The purpose is to
 * report error conditions in a consistent manner
 */
...
public class ApplicationError extends RuntimeException {
    ...
    /**
     * Create an application error with just an error code - note: this is to be
     * used for internal passing of application errors and not to be used to pass
    ...
    /**
     * Create an application error with just a description and resolution. The
     * details are determined from a stack trace of this exception itself
     */
    ...
    public String toString() {
        if (bSkipToString)
            return ""; // hack for times when stack trace of 'this' needed as details
        else {
            String sExtra = "";
            ...
            return "Error #" + nErrorCode_ + ", Message: " + sMessage_ + ", Details: " + sDetails_
    ...
    public String toStringNoStackTrace() {
        ...
        if (this.bDetailsIsException_)
            sDetails = "";
        return "Error #" + nErrorCode_ + ", Message: " + sMessage_ + sDetails
                + (sSuggestedResolution_ == null ? "" : ", Suggested Resolution: " + sSuggestedResolution_);
    ...
    public static void assertNotNull(Object o, String sDetails) {
        if (o == null)
            throw new ApplicationError(ErrorCodes.ERROR_NULL, "ASSERTION FAILURE: Unexpected null value - " + sDetails,
                    null);
    }
    ...
    public static void assertNotNull(Object o, String sDetails, Object oInfo) {
        if (o == null)
            throw new ApplicationError(ErrorCodes.ERROR_NULL, "ASSERTION FAILURE: Unexpected null value - " + sDetails,
                    oInfo == null ? "" : oInfo.toString(), null);
    }

    public static void assertNull(Object o, String sDetails) {
        if (o != null)
            throw new ApplicationError(ErrorCodes.ERROR_NULL,
    ...
    public static void assertNull(Object o, String sDetails, Object oInfo) {
        if (o != null)
            throw new ApplicationError(ErrorCodes.ERROR_NULL,
                    "ASSERTION FAILURE: Unexpected non-null value - " + sDetails, oInfo == null ? "" : oInfo.toString(),
                    null);
    }
    ...
    public static void assertTrue(boolean b, String sDetails, Object oInfo) {
        if (!b)
            throw new ApplicationError(ErrorCodes.ERROR_ASSERTION_FAILED,
                    "ASSERTION FAILURE: Unexpected condition - " + sDetails, oInfo == null ? "" : oInfo.toString(),
                    null);
    }
