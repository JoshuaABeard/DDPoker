...
public class ZipUtil extends ZipFile {
    ...
    /**
     * Returns byte array containing data of current entry (the contents of file
     * name returned by most recent call to getNextFileName()
     */
    ...
    public StringBuilder getStringBufferContents() throws IOException {
        ...
        BufferedReader buf = new BufferedReader(new InputStreamReader(getInputStream(zeCurrent)));
        String sLine;
