...
public class PasswordGenerator {
    ...
    public static final int OPTION_ALL = (OPTION_INCLUDE_LETTERS | OPTION_INCLUDE_MIXED_CASE | OPTION_INCLUDE_NUMBERS
            | OPTION_INCLUDE_PUNCTUATION | OPTION_EXCLUDE_SIMILAR);
    ...
    /**
     * Generate a password of the given length using the current time as random
    ...
    /**
     * Generate a password of the given length using the given random number
     * generator seed.
     */
