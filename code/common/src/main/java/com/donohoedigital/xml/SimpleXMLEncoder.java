...
public class SimpleXMLEncoder {
    ...
    /**
     * Set current object null and start new tag with name "alias". Used for
     * manually creating entries like lists.
     */
    ...
    /**
     * Add tags by introspection of current object, looking for getters matching
     * names
     */
