...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: May 9, 2006 Time: 8:08:32 PM To
...
public class DispatchQueue extends Thread {
    ...
    public void run() {
        ...
        // used to quit (cleanup). A IncomingQueue on the work queue means to process
        // messages
        // on that queue.
        Object msg;
        while (!bDone_) {
