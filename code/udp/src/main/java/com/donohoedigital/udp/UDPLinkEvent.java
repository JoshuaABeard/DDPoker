...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: May 12, 2006 Time: 10:16:54 AM
 * To change this template use File | Settings | File Templates.
 */
public class UDPLinkEvent {
    // event types enum
    public enum Type {
        ESTABLISHED("established"), CLOSING("closing"), CLOSED("closed"), RECEIVED("received"), TIMEOUT(
                "timeout"), POSSIBLE_TIMEOUT("possible-timeout"), RESEND_FAILURE(
                        "resend-failure"), SESSION_CHANGED("session-changed"), MTU_TEST_FINISHED("mtu-test-finished");
