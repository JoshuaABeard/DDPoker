...
/**
 * Wrapper class to provide easy access to online data contained in a DDMessage
 * object (used to pass data between games)
 *
 * @author donohoe
 */
public class OnlineMessage {
    ...
    public static final String ON_FROM = "from"; // used in chat, hand action, quit, (any message from a particular
                                                    // player)
    public static final String ON_TABLE = "table"; // used in chat to indicate table number chat is going to & change
                                                    // table
    ...
    // used in chat to indicate a "dealer/host" info message, different than -1
    // above
    ...
    /**
     * Creates a new instance of OnlineMessage with the DDMessage source data
     */
    ...
    /**
     * Creates a new instance of OnlineMessage with the DDMessage source data and
     * the socket channel it was received on
     */
    ...
    /**
     * Create a new instance of OnlineMessage that is empty
     */
    ...
    /**
     * Get player list as array of OnlinePlayerInfo (constructed each time, so
     * caller should cache)
     */
