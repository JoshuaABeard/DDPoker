 ...
 * <p>
 * This configuration:
 * - Serves static files (HTML, CSS, JS, images) from /app/webapp/
 * - Handles client-side routing by falling back to index.html for missing resources
 * - Excludes /api/* paths from fallback to let API 404s happen normally
 */
@Configuration
