...
class HandInfoFasterTest {
    ...
    void should_RecognizeRoyalFlush_When_AKQJT_SameSuit() {
        ...
        // Assert
        int handType = score / HandScoreConstants.SCORE_BASE;
        assertThat(handType).isEqualTo(HandScoreConstants.ROYAL_FLUSH);
    ...
    void should_RecognizeStraightFlush_When_FiveConsecutiveSameSuit() {
        ...
        // Assert
        int handType = score / HandScoreConstants.SCORE_BASE;
        assertThat(handType).isEqualTo(HandScoreConstants.STRAIGHT_FLUSH);
    ...
    void should_RecognizeQuads_When_FourSameRank() {
        ...
        // Assert
        int handType = score / HandScoreConstants.SCORE_BASE;
        assertThat(handType).isEqualTo(HandScoreConstants.QUADS);
    ...
    void should_ScoreQuadsByRankAndKicker_When_Comparing() {
        ...
        assertThat(handType).isEqualTo(HandScoreConstants.QUADS);
        // 8*BASE + 8*H1 + 14*H0
        int expectedScore = 8 * HandScoreConstants.SCORE_BASE + 8 * HandScoreConstants.H1 + 14 * HandScoreConstants.H0;
    ...
    void should_RecognizeFullHouse_When_TripsAndPair() {
        ...
        // Assert
        int handType = score / HandScoreConstants.SCORE_BASE;
        assertThat(handType).isEqualTo(HandScoreConstants.FULL_HOUSE);
    ...
    void should_RecognizeFlush_When_FivePlusSameSuit() {
        ...
        // Assert
        int handType = score / HandScoreConstants.SCORE_BASE;
        assertThat(handType).isEqualTo(HandScoreConstants.FLUSH);
    ...
    void should_RecognizeStraight_When_FiveConsecutiveRanks() {
        ...
        // Assert
        int handType = score / HandScoreConstants.SCORE_BASE;
        assertThat(handType).isEqualTo(HandScoreConstants.STRAIGHT);
    ...
    void should_RecognizeTrips_When_ThreeSameRank() {
        ...
        // Assert
        int handType = score / HandScoreConstants.SCORE_BASE;
        assertThat(handType).isEqualTo(HandScoreConstants.TRIPS);
    ...
    void should_RecognizeTwoPair_When_TwoPairs() {
        ...
        // Assert
        int handType = score / HandScoreConstants.SCORE_BASE;
        assertThat(handType).isEqualTo(HandScoreConstants.TWO_PAIR);
    ...
    void should_RecognizePair_When_TwoSameRank() {
        ...
        // Assert
        int handType = score / HandScoreConstants.SCORE_BASE;
        assertThat(handType).isEqualTo(HandScoreConstants.PAIR);
    ...
    void should_RecognizeHighCard_When_NoMadeHand() {
        ...
        // Assert
        int handType = score / HandScoreConstants.SCORE_BASE;
        assertThat(handType).isEqualTo(HandScoreConstants.HIGH_CARD);
    ...
    void should_SkipBlankCards_When_MidGameJoin() {
        ...
        int handType = score / HandScoreConstants.SCORE_BASE;
        assertThat(handType).isEqualTo(HandScoreConstants.PAIR); // Pair of aces
    }
    ...
    void should_HandleMinimumFiveCards_When_Evaluating() {
        ...
        // Assert
        int handType = score / HandScoreConstants.SCORE_BASE;
        assertThat(handType).isEqualTo(HandScoreConstants.STRAIGHT); // A-K-Q-J-T straight
    }
    ...
    void should_HandleMaxSevenCards_When_ChooseBestFive() {
        ...
        // Assert
        int handType = score / HandScoreConstants.SCORE_BASE;
        assertThat(handType).isEqualTo(HandScoreConstants.STRAIGHT); // 6-high straight
    }
