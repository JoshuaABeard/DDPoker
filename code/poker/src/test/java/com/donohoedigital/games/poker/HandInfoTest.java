...
class HandInfoTest {
    ...
    void should_RankQuadsHigher_When_ComparingQuadsToFullHouse() {
        ...
        HandInfo quads = createHandInfo("Quads", CLUBS_8, HEARTS_8, DIAMONDS_8, SPADES_8, SPADES_7, DIAMONDS_2, HEARTS_3);
        HandInfo fullHouse = createHandInfo("Full House", CLUBS_A, HEARTS_A, DIAMONDS_A, CLUBS_K, SPADES_K, DIAMONDS_2, HEARTS_3);
    ...
    void should_RankFullHouseHigher_When_ComparingFullHouseToFlush() {
        ...
        HandInfo fullHouse = createHandInfo("Full House", CLUBS_8, HEARTS_8, DIAMONDS_8, CLUBS_Q, SPADES_Q, DIAMONDS_2, HEARTS_3);
    ...
    void should_RankFlushHigher_When_ComparingFlushToStraight() {
        ...
        HandInfo straight = createHandInfo("Straight", CLUBS_9, HEARTS_T, DIAMONDS_J, SPADES_Q, CLUBS_K, SPADES_2, HEARTS_3);
    ...
    void should_RankStraightHigher_When_ComparingStrightToTrips() {
        ...
        HandInfo straight = createHandInfo("Straight", CLUBS_2, HEARTS_3, DIAMONDS_4, SPADES_5, CLUBS_6, SPADES_A, HEARTS_K);
    ...
    void should_RankTripsHigher_When_ComparingTripsTwoTwoPair() {
        ...
        HandInfo twoPair = createHandInfo("Two Pair", CLUBS_A, HEARTS_A, DIAMONDS_K, SPADES_K, CLUBS_Q, SPADES_2, HEARTS_3);
    ...
    void should_RankTwoPairHigher_When_ComparingTwoPairToPair() {
        ...
        HandInfo twoPair = createHandInfo("Two Pair", CLUBS_2, HEARTS_2, DIAMONDS_3, SPADES_3, CLUBS_A, SPADES_K, HEARTS_Q);
    ...
    void should_RankPairHigher_When_ComparingPairToHighCard() {
        ...
        HandInfo highCard = createHandInfo("High Card", CLUBS_A, HEARTS_K, DIAMONDS_Q, SPADES_J, CLUBS_9, SPADES_7, HEARTS_5);
    ...
    void should_RankHigherQuads_When_QuadsDiffer() {
        ...
        HandInfo quadsAces = createHandInfo("Quads Aces", CLUBS_A, HEARTS_A, DIAMONDS_A, SPADES_A, CLUBS_K, SPADES_2, HEARTS_3);
        HandInfo quadsKings = createHandInfo("Quads Kings", CLUBS_K, HEARTS_K, DIAMONDS_K, SPADES_K, CLUBS_A, SPADES_2, HEARTS_3);
    ...
    void should_RankHigherFullHouse_When_TripsPartDiffers() {
        ...
        HandInfo fullHouseAces = createHandInfo("FH Aces", CLUBS_A, HEARTS_A, DIAMONDS_A, SPADES_K, CLUBS_K, SPADES_2, HEARTS_3);
        HandInfo fullHouseKings = createHandInfo("FH Kings", CLUBS_K, HEARTS_K, DIAMONDS_K, SPADES_A, CLUBS_A, SPADES_2, HEARTS_3);
    ...
    void should_RankHigherStraight_When_HighCardDiffers() {
        ...
        HandInfo straightNine = createHandInfo("Straight 9", CLUBS_5, HEARTS_6, DIAMONDS_7, SPADES_8, CLUBS_9, SPADES_A, HEARTS_K);
        HandInfo straightEight = createHandInfo("Straight 8", CLUBS_4, HEARTS_5, DIAMONDS_6, SPADES_7, CLUBS_8, SPADES_A, HEARTS_K);
    ...
    void should_UseKickerForTieBreak_When_PairsSame() {
        ...
        HandInfo pairAcesKingKicker = createHandInfo("Pair A K", CLUBS_A, HEARTS_A, DIAMONDS_K, SPADES_Q, CLUBS_J, SPADES_2, HEARTS_3);
        HandInfo pairAcesQueenKicker = createHandInfo("Pair A Q", CLUBS_A, HEARTS_A, DIAMONDS_Q, SPADES_J, CLUBS_T, SPADES_2, HEARTS_3);
    ...
    void should_TieWhenIdentical_When_HandsHaveSameScore() {
        ...
        HandInfo hand2 = createHandInfo("Hand 2", DIAMONDS_A, SPADES_K, CLUBS_Q, HEARTS_J, DIAMONDS_T, CLUBS_2, SPADES_3);
    ...
    void should_EvaluateRoyalFlushTie_When_BothHaveRoyalFlush() {
        ...
        HandInfo royal2 = createHandInfo("Royal 2", DIAMONDS_A, DIAMONDS_K, DIAMONDS_Q, DIAMONDS_J, DIAMONDS_T, SPADES_2, HEARTS_3);

        assertThat(royal1.getScore()).isEqualTo(royal2.getScore());
    }

    private static void verify(String name, int expected, Card c1, Card c2, Card c3, Card c4, Card c5, Card c6, Card c7) {
        ...
        assertThat(fastScore)
                ...
                .isEqualTo(expected);
        assertThat(fastScore)
                .as("Fast score for %s doesn't match info score", name)
                .isEqualTo(info.getScore());
        assertThat(fasterScore)
                .as("Faster score for %s doesn't match info score", name)
                .isEqualTo(info.getScore());
    }
