...
public class TableListPanel extends DDTabPanel implements ChangeListener, ActionListener {
    ...
    public void createUI() {
        ...
        int nNumPlayers = game_.isGameOver()
                ? game_.getTable(0).getNumOccupiedSeats()
        ...
        topinfo.setText(PropertyConfig.getMessage(p.isObserver() ? "msg.tablesum.observer" : "msg.tablesum.player",
                ...
                nNumPlayers, p.getTable().getName(), p.getSeat() + 1, sWait));
    ...
    private class TablePanel extends DDPanel {
        ...
        public TablePanel() {
            ...
            scroll.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED); // set to as needed to trigger
                                                                                            // size set below
    ...
    private static final String[] PLAYING_NAMES = new String[]{ChipLeaderPanel.COL_SEAT,
            ChipLeaderPanel.COL_NAME_PLAYERTYPE, ChipLeaderPanel.COL_CHIPS};
    // client table info
    private static final int[] PLAYING_WIDTHS = new int[]{40, ChipLeaderPanel.NW + 80, ChipLeaderPanel.CW};
}
