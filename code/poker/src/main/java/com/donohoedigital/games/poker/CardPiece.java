...
public class CardPiece extends PokerGamePiece {
        ...
        if (pokerplayer_ != null) {
            ...
            if (bThumbnailMode_) {
                ...
                switch (nOrder) {
                    ...
                    default :
                        throw new ApplicationError(ErrorCodes.ERROR_CODE_ERROR, "too many color up cards: " + nSeq_,
                                null);
                }

                if (bShiftRight)
                    x_adjust += (int) (CARD_W * getScale() * .5d);
    ...
    public void drawImageAt(Graphics2D g, ImageComponent ic, int nNum, int nHiddenNum, int nMovingNum, double x,
        ...
        super.drawImageAt(g, ic, nNum, nHiddenNum, nMovingNum, x, y, width, height, dScale);
        ...
        if (!bThumbnailMode_) {
            ...
            if (bLarge || card.isFaceCard()) {
                g.setColor(c);
                g.drawRect((int) boxx, (int) boxy, (int) Math.round(boxwidth), (int) Math.round(boxheight));
                    ...
                    case Card.KING :
                        if (stylized) {
                            if (fourColorDeck)
                                ...
                                return FaceCards.Style_King_Clubs_Blk;
                        }
                    ...
                    case Card.KING :
                        if (stylized) {
                            if (fourColorDeck)
                                ...
                                return FaceCards.Style_King_Diamonds_Red;
                        }
    ...
    /**
     * class to represent pip location and whether it is drawn upside down
     */
    ...
    public static class CardImageComponent extends EmptyImageComponent {
        ...
        public void drawImageAt(Graphics2D g, int x, int y, int width, int height) {
            ...
            if (bStroke_ && isEnabled()) {
                ...
                BasicStroke borderStroke = new BasicStroke(strokewidth, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND);
