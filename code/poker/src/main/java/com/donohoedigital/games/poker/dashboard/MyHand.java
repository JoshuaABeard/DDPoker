...
public class MyHand extends DashboardItem {
    // current instance of my hand - used by DealDisplay to notify when a deal is
    // finished
    ...
    public MyHand(GameContext context) {
        ...
        trackTableEvents(
                PokerTableEvent.TYPE_END_HAND | PokerTableEvent.TYPE_CARD_CHANGED | PokerTableEvent.TYPE_NEW_HAND);
    }
    ...
    protected JComponent createBody() {
        ...
        base.add(htmlHand_,
                new ExplicitConstraints(htmlHand_, width.subtract(ComponentEF.preferredWidth(htmlHand_)).multiply(.5d),
                        MathEF.constant(0), ComponentEF.preferredWidth(htmlHand_),
