...
public class ImpExpParadise implements ImpExp {
    ...
    public String exportTournament(ImpExpHand ieHand) {
        ...
        buf.append(newline);
        /*
         * 2nd: panda bear, $60 prize awarded (Level IX, Game #6) 3rd: leoben, $40 prize
         * awarded (Level VI, Game #10)
         *
         * 4th: Sargent1 (Level V, Game #7) 5th: acedad (Level V, Game #4) 6th:
         * deznuttzz (Level IV, Game #6) 7th: jedi master (Level IV, Game #3) *** 8th:
         * GMATTSON9900 (Level IV, Game #2) 9th: BASSMASSTER (Level III, Game #4) 10th:
         * mpshanah (Level I, Game #4)
         */
    ...
    private static final String rankName_[] = new String[]{null, null, "two", "three", "four", "five", "six", "seven",
