...
public class StatResult {
    ...
    public String toHTML() {
        return PropertyConfig.getMessage("msg.stats.html", Double.toString(winPercent_), Double.toString(losePercent_),
                Double.toString(tiePercent_), Integer.toString(handCount_));
    }
