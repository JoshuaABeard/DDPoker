...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: May 16, 2005 Time: 2:08:23 PM
...
public class OnlineDash extends DashboardItem {
    ...
    public OnlineDash(GameContext context) {
        ...
        trackTableEvents(PokerTableEvent.TYPE_PLAYER_SETTINGS_CHANGED | PokerTableEvent.TYPE_NEW_HAND); // for demo
        game_.addPropertyChangeListener(PokerGame.PROP_GAME_LOADED, this);
        // game_.addPropertyChangeListener(PokerGame.PROP_GAME_OVER, this); // may be
        // needed in future
    }
    ...
    protected void updateInfo() {
        if ((sitout_ != null && player_.isObserver()) || (sitout_ == null && !player_.isObserver())) {
            createComponents();
            base_.repaint();
            return;
        }
