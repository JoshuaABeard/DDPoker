...
public class PokerStartMenu extends StartMenu {
    ...
    /**
     * we override to do nothing — control buttons are added directly in
     * subclassInit
     */
    @Override
    ...
    private void profileCheck() {
        ...
        // Future: wire into startup flow — if profile_ is non-null and isOnline(),
        ...
        if (profile_ == null) {
            // Future: wire into startup flow — replace this block with FirstRunWizard when
