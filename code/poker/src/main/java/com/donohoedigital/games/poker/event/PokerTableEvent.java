...
public class PokerTableEvent implements DataMarshal {
    ...
    public String getTypeAsString() {
        switch (nType_) {
            case TYPE_NEW_HAND :
                return "new-hand";
            case TYPE_PLAYER_ADDED :
                return "player-added";
            case TYPE_PLAYER_REMOVED :
                return "player-removed";
            case TYPE_CURRENT_PLAYER_CHANGED :
                return "current-player-changed";
            case TYPE_PLAYER_ACTION :
                return "player-action";
            case TYPE_DEALER_ACTION :
                return "dealer-action";
            case TYPE_LEVEL_CHANGED :
                return "level-changed";
            case TYPE_TABLE_REMOVED :
                return "table-removed";
            case TYPE_BUTTON_MOVED :
                return "button-moved";
            case TYPE_PREFS_CHANGED :
                return "prefs-changed";
            case TYPE_STATE_CHANGED :
                return "state-changed";
            case TYPE_PLAYER_ADDON :
                return "addon";
            case TYPE_PLAYER_REBUY :
                return "rebuy";
            case TYPE_END_HAND :
                return "end-hand";
            case TYPE_OBSERVER_ADDED :
                return "observer-added";
            case TYPE_OBSERVER_REMOVED :
                return "observer-removed";
            case TYPE_CLEANING_DONE :
                return "cleaning-done";
            case TYPE_PLAYER_AI_CHANGED :
                return "player-ai-changed";
            case TYPE_PLAYER_SETTINGS_CHANGED :
                return "player-settings-changed";
        }
    ...
    public String toString() {
        ...
        if (nType_ == TYPE_STATE_CHANGED) {
            ...
            if (nOne_ != NOT_DEFINED)
                sb.append("; 1st=").append(nOne_);
            if (nTwo_ != NOT_DEFINED)
                sb.append("; 2nd=").append(nTwo_);
        }
        return sb.toString();
    }
    ...
    /**
     * Get seat added to or removed from for TYPE_PLAYER_ADDED and
     * TYPE_PLAYER_REMOVED events
     */
    public int getSeat() {
        return nOne_;
    }
    ...
    /**
     * Get old int value. For TYPE_BUTTON_MOVED, returns old button seat. For
     * TYPE_CURRENT_PLAYER_CHANGED returns index of old current player. For
     * TYPE_LEVEL_CHANGED returns old level. For TYPE_STATE_CHANGED returns old
     * state.
     */
    public int getOld() {
        return nOne_;
    ...
    /**
     * Get new int value. For TYPE_BUTTON_MOVED, returns new button seat. For
     * TYPE_CURRENT_PLAYER_CHANGED returns index of new current player. For
     * TYPE_LEVEL_CHANGED returns new level. For TYPE_STATE_CHANGED returns new
     * state.
     */
    public int getNew() {
        return nTwo_;
