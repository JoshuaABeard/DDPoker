...
public class PrizePoolDialog extends DialogPhase implements ChangeListener {
    ...
    public JComponent createDialogContents() {
        ...
        if (!profile_.isAllocFixed()) {
            ...
            amount_ = new DDNumberSpinner(profile_.getTrueBuyin(), Integer.MAX_VALUE, profile_.getTrueBuyin(),
                    GuiManager.DEFAULT, "PrizePool");
            ...
            if (nCash == 0)
                nCash = profile_.getNumPlayers() * profile_.getBuyinCost();
