...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Jun 12, 2005 Time: 4:10:28 PM
...
public class CheatDash extends DashboardItem implements ChangeListener {
    ...
    protected JComponent createBody() {
        ...
        GamePrefsPanel.addCheatOptions(GameEngine.getGameEngine().getPrefsNodeName(), cheatbase, "DashSmaller",
                new TypedHashMap(), false);
