...
public class PreShowdown extends ChainPhase {
    ...
    public void process() {
        ...
        if (game.isOnlineGame()) {
            ...
            if (bWinner) {
                GameButton bShow = EngineUtils.displayConfirmationDialogCustom(context_, "ShowWinning", null, null,
                        null, null);
                ...
                GameButton bShow = EngineUtils.displayConfirmationDialogCustom(context_, "ShowLosing", null, null, null,
                        null);
                if (bShow != null && bShow.getName().startsWith("yes")) {
