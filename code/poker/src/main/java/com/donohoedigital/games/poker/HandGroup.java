...
public class HandGroup extends BaseProfile {
    ...
    /*
     * public String getFileName() { return sFileName_ == null ? sName_ :
     * sFileName_; }
     */
    /**
    ...
    public static List<BaseProfile> getProfileList() {
        return BaseProfile.getProfileList(HAND_GROUP_DIR,
                Utils.getFilenameFilter(SaveFile.DELIM + PROFILE_EXT, PROFILE_BEGIN), HandGroup.class, false);
    }
    ...
    public String toHTML() {
        ...
        return (sDesc != null ? sDesc.replaceAll("\n", "<BR>\n") + sBreak : "") + "<DIV>" + "<DDHANDGROUP CARDS=\""
                + getSummary().replaceAll(" ", "") + "\">" + "</DIV>";
    }
