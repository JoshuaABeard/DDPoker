...
public abstract class Odds extends DashboardItem {
    ...
    public Odds(GameContext context, String sName) {
        super(context, sName);
        trackTableEvents(PokerTableEvent.TYPE_CURRENT_PLAYER_CHANGED | PokerTableEvent.TYPE_DEALER_ACTION
                | PokerTableEvent.TYPE_CARD_CHANGED | PokerTableEvent.TYPE_NEW_HAND | PokerTableEvent.TYPE_END_HAND);
    }
