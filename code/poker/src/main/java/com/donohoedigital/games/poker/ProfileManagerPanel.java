...
public class ProfileManagerPanel extends DDPanel implements ChangeListener {
    ...
    public ProfileManagerPanel(GameEngine engine, GameContext context, String sName, String sStyle, String sManagerType,
            Class profileClass) {
        super(sName, sStyle);
        ...
        try {
            profiles = (ArrayList) profileClass_.getMethod("getProfileList", (java.lang.Class[]) null).invoke(null,
        ...
        profileList_ = new MyProfileList(engine, context, profiles, sStyle, sManagerType, sHelpName, "pokericon16png",
                true);
    ...
    protected JComponent createSummary(String sHelpName, String sStyle) {
        ...
        JScrollPane scroll = new DDScrollPane(summaryHTML_, sStyle, null, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
    ...
    protected void updateSummary() {
        ...
        if (pp != null) {
            ...
            if (isTitleCustomized()) {
                summaryBorder_.setText(
                        PropertyConfig.getMessage("labelborder." + sManagerType_ + ".summary.label2", pp.getName()));
    ...
    /**
     * whether this profile has a customized summary title (per profile). Default is
     * true
     */
    ...
    private class MyProfileList extends ProfileList {
        public MyProfileList(GameEngine engine, GameContext context, ArrayList profiles, String sStyle, String sMsgName,
        ...
        protected BaseProfile copyProfile(BaseProfile profile, boolean bForEdit) {
            ...
            return (BaseProfile) ConfigUtils.newInstance(profileClass_, new Class[]{profileClass_, String.class},
                    new Object[]{profile, sName});
        }
