...
public class ExitPoker extends BasePhase {
    ...
    public void start() {
        ...
        // determine confirmation message - if game is online game and the player has a
            ...
            switch (game_.getOnlineMode()) {
                ...
                case PokerGame.MODE_CLIENT :
                    ...
                    if (!game_.isInProgress() && game_.getNumTables() == 0) {
                        // Note: QuitPokerGame not available in lobby, so this is okay considering
                        // subclassing
        ...
        String sDetails = "";
        if (sDetailsKey != null)
            sDetails = PropertyConfig.getMessage(sDetailsKey, getActionDisplay(), sParam1);
