...
public class TableDesign extends BaseProfile {
    ...
    public static List<BaseProfile> getProfileList() {
        return BaseProfile.getProfileList(TABLE_DESIGN_DIR,
                Utils.getFilenameFilter(SaveFile.DELIM + PROFILE_EXT, PROFILE_BEGIN), TableDesign.class, false);
    }
