...
public class AdvisorGridPanel extends DDPanel {
    ...
    private static final Color colors_[] = new Color[]{Color.RED.darker().darker(), Color.RED.darker(),
    ...
    public String getHand(MouseEvent e) {
        ...
        if (bPreFlop_) {
            ...
            if (rank1 < rank2) {
                ...
                return Card.getRankSingle(rank2) + CardSuit.forRank(suit).getAbbr() + Card.getRankSingle(rank1)
                ...
                return Card.getRankSingle(rank1) + CardSuit.forRank(suit1).getAbbr() + Card.getRankSingle(rank2)
