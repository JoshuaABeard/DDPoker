...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Jun 22, 2006 Time: 11:04:53 AM
...
public class CountdownPanel extends DDPanel implements ActionListener {
    ...
    public void countdown(boolean b) {
        ...
        if (b) {
            ...
            if (hh == null)
                return;
            ClientPlayer player = hh.getCurrentPlayer();
            if (player == null)
                return;
    ...
    private void setToolTip() {
        ...
        if (count_ != null) {
            ...
            sToolTip = PropertyConfig.getMessage("msg.tooltip.countdown", to, (to == 1 ? secSingular : secPlural), tb,
                    (tb == 1 ? secSingular : secPlural), getElapsed() / 1000, ((int) total_) / 1000);
        }
    ...
    public void paintComponent(Graphics g1) {
        if (count_ == null)
            return; // no painting if no counter
