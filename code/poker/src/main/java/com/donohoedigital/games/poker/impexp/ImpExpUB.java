...
public class ImpExpUB implements ImpExp {
    ...
    public String exportHand(ImpExpHand ieHand) {
         ...
         * buf.append("-"); buf.append(ieHand.hndNumber); buf.append(" Summary:");
         * buf.append(newline);
         *
         * buf.append(newline);
         *
         * buf.append("  No rake is taken for this hand."); buf.append(newline);
         */
        /*
         * woody13 folds. jcman folds. ColbySophie folds. kdsinbham folds. eckohockey12
         * folds. RNemetz folds. beachrat1946 folds. AspenX is returned 800 (uncalled).
         *
         *
         *
         ...
         *
         *
         * mikemicdee posts the small blind of $2. Legendary posts the big blind of $4.
         *
         * slambamiel: -- -- junkie pride: -- -- bluffster11: -- -- internation: -- --
         * cmw: -- -- pikervinsang: -- -- xJMPx: -- -- jakeum1970: -- -- mikemicdee: --
         * -- Legendary: -- --
         *
         * Pre-flop:
         *
         * slambamiel calls. junkie pride folds. bluffster11 raises to $18. internation
         * folds. cmw folds. pikervinsang folds. xJMPx folds. jakeum1970 folds.
         * mikemicdee folds. Legendary folds. slambamiel calls.
         *
         * Flop (board: Js 3c Ac):
         *
         * slambamiel checks. bluffster11 bets $42. slambamiel raises to $84.
         * bluffster11 goes all-in for $72. slambamiel is returned $12 (uncalled).
         *
         ...
         * Showdown:
         *
         * slambamiel shows As Jh. slambamiel has As Jh Js Ac Qs: two pair, aces and
