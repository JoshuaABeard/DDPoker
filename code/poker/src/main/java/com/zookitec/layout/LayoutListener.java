...
/**
 * Interface for classes that can be notified each time ExplicitLayout lays out
 * its container.
 *
 *
 * <P>
 * For example, a LayoutListener can be used to modify the layout constraints
 * depending on the container's width / height ratio.
 * </P>
 *
 */
