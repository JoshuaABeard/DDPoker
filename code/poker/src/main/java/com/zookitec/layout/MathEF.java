...
/**
 * An expression factory used to create expressions for common mathematical
 * operations.
 */
public class MathEF {
    ...
    /**
     * Creates an expression for expr1 + expr2Value. This is equivalent to
     * <code>add(expr1, MathEF.constant(expr2Value))</code>.
     *
     * @param expr1
     *            an expression
     * @param expr2Value
    ...
    /**
     * Creates an expression for expr1 - expr2Value. This is equivalent to
     * <code>subtract(expr1, MathEF.constant(expr2Value))</code>.
     *
     * @param expr1
     *            an expression
     * @param expr2
    ...
    /**
     * Creates an expression for expr1 * expr2Value. This is equivalent to
     * <code>multiply(expr1, MathEF.constant(expr2Value))</code>.
     *
     * @param expr1
     *            an expression
     * @param expr2Value
    ...
    /**
     * Creates an expression for expr1 / expr2Value. This is equivalent to
     * <code>divide(expr1, MathEF.constant(expr2Value))</code>.
     *
     * @param expr1
     *            an expression
     * @param expr2Value
    ...
    /**
     * Creates an expression equal in value to the operand expression with the
     * largest value.
     *
     * @param operands
     *            the operands of this expression
     *
     * @return an expression equal in value to the operand expression with the
     *         largest value.
     */
    ...
    /**
     * Equivalent to <code>max(Expression [] operands)</code> where operands[0] =
     * expr1 and operands[1] = expr2. This method is provided for convenience when
     * the maximum of just two expressions is required.
     *
     * @param expr1
     *            an expression
     * @param expr2
    ...
    /**
     * Equivalent to <code>min(Expression [] operands)</code> where operands[0] =
     * expr1 and operands[1] = expr2. This method is provided for convenience when
     * the minimum of just two expressions is required.
     *
     * @param expr1
     *            an expression
     * @param expr2
    ...
    static class MathExpression extends Expression {
         ...
         *
         * @param expressions
         *            An array of expressions on which the value of this expression
         *            depends; this cannot be null.
         */
