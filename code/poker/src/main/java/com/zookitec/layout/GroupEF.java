...
/**
 * An expression factory used to create expressions that depend on attributes of
...
public class GroupEF {
    ...
    /**
     * Creates an expression for the top coordinate of the component group; this is
     * the minimum top y coordinate of all components in the group.
     *
     * @param group
    ...
    /**
     * Creates an expression for the bottom coordinate of the component group; this
     * is the maximum bottom y coordinate of all components in the group.
     *
     * @param group
     *            an array of components
    ...
    /**
     * Creates an expression for the left coordinate of the component group; this is
     * the minimum left x coordinate of all components in the group.
     *
     * @param group
     *            an array of components in the group
    ...
    /**
     * Creates an expression for the right coordinate of the component group; this
     * is the maximum right x coordinate of all components in the group.
     *
     * @param group
     *            an array of components in the group
     * @return an Expression
    ...
    /**
     * Creates an expession for the height of the component group. This is the
     * bottom coordinate of the group minus the top y coordinate of the group.
     *
     * @param group
     *            an array of components in the group
     * @return an Expression
    ...
    /**
     * Creates an expession for the y coordinate of a fraction of the height of the
     * component group.
     *
     * @param group
     *            an array of components in the group
    ...
    /**
     * Creates an expression for the sum of the component preferred heights in the
     * group.
     *
     * @param group
     *            an array of components in the group
    ...
    /**
     * Creates an expression for the maximum component preferred height in the
     * group.
     *
     * @param group
     *            an array of components in the group
    ...
    /**
     * Creates an expression for the minimum component preferred height in the
     * group.
     *
     * @param group
     *            an array of components in the group
    ...
    /**
     * Create an expression for the sum of the component minimum heights in the
     * group.
     *
     * @param group
     *            an array of components in the group
    ...
    /**
     * Create an expression for the sum of the component maximum heights in the
     * group.
     *
     * @param group
     *            an array of components in the group
    ...
    /**
     * Create an expession for the width of the component group. This is the
     * rightmost component right x coordinate minus the leftmost component left x
     * coordinate.
     *
     *
     * @param group
    ...
    /**
     * Creates an expession for the x coordinate of a fraction of the width of the
     * component group.
     *
     * @param group
     *            an array of components in the group
    ...
    /**
     * Create an expression for the sum of the component preferred widths in the
     * group.
     *
     * @param group
     *            an array of components in the group
    ...
    /**
     * Creates an expression for the sum of the component minimum widths in the
     * group.
     *
     *
     * @param group
    ...
    /**
     * Creates an expression for the sum of the component maximum widths in the
     * group.
     *
     * @param group
     *            an array of components in the group
    ...
    /**
     * Creates an array of expressions for the specified attibute of each component
