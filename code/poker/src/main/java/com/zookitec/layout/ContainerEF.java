...
/**
 * An expression factory used to create expressions for attributes of the
...
public class ContainerEF {
    ...
    /**
     * Creates an expression for the container left coordinate. This is the left
     * inset of the container.
     *
    ...
    /**
     * Creates an expression for the container top coordinate. This is the top inset
     * of the container.
     *
    ...
    /**
     * Creates an expression for the container right coordinate taking into account
     * the insets. This is the width of the container minus the right inset.
     *
    ...
    /**
     * Creates an expression for the container bottom coordinate taking into account
     * the insets. This is the height of the container minus the bottom inset.
     *
    ...
    /**
     * Gets an expression for the left x coordinate of the grid column specified by
     * <code>gridColumn</code>. The grid is positioned at the left of the container
     * with cell width defined by the specified <code>cellWidth</code>
     * expression.<br>
     * For example, to get an expression for the left x coordinate of column 3 of a
     * 6 column grid that fills the container, you could call this method as
     * follows:<br>
     * <br>
     * <code>ContainerEF.gridX(3, ContainerEF.widthFraction(1 / 6.0));</code>
     *
     * @param gridColumn
     *            the grid column index starting at 0.
     * @param cellWidth
     *            an expression for the grid cell width.
     *
     * @return an expression
     */
    ...
    /**
     * Gets an expression for the top y coordinate of the grid row specified by
     * <code>gridRow</code>. The grid is positioned at the top of the container with
     * cell height defined by the specified <code>cellHeight</code> expression.
     *
     * @param gridRow
     *            the grid row index starting at 0.
     * @param cellHeight
     *            an expression for the grid cell height.
     *
     * @return an expression
     */
