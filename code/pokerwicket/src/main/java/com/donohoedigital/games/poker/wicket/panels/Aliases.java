...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Apr 21, 2008 Time: 12:38:56 PM
...
public class Aliases extends VoidPanel {
    ...
    /**
     * DESIGN NOTE: Decided to show aliases for retired players because someone may
     * want to know the aliases for a newly retired player (e.g., - where did "xyz"
     * go?)
     */
    ...
    private class AliasModel extends LoadableDetachableModel<List<OnlineProfile>> {
        ...
        protected List<OnlineProfile> load() {
            if (user == null)
                return new ArrayList<OnlineProfile>();
