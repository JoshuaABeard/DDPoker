...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Apr 17, 2008 Time: 5:58:11 PM
...
public class TopNavigation extends VoidPanel {
    ...
    public TopNavigation(String id, String style) {
        ...
        // make root page and mount path accessible in JS via
        // document.getElementById('header').dataset.mount|root;
