...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Apr 18, 2008 Time: 11:02:44 AM
...
public abstract class BasePokerPage extends BasePage<Void> {
    ...
    /**
     * Is login panel visible (in current profile panel - result passed to
     * CurrentProfile constructor). Default is false.
     *
