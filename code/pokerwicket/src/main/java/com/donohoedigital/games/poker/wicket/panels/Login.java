...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Apr 18, 2008 Time: 12:21:48 PM
    ...
    public Login(String id, boolean visibleToUser) {
        ...
        Form<Login> form = new StatelessForm<Login>("login", new CompoundPropertyModel<>(this)) {
            ...
            protected void onSubmit() {
                Login.this.visibleToUser = !new LoginUtils((BasePage<?>) getPage()).loginFromPage(name, password,
                        remember);
            }
        };
        add(form);
