...
/**
 * Contains query results whose values are set according to the current result
 * row.
 */
public class ResultMap extends DMTypedHashMap {
     ...
     *
     * @return <code>true</code> if there was a new result row, <code>false</code>
     *         otherwise
     */
    public boolean next() throws SQLException {
        ...
        // This method assumes paging is built into the SQL query (e.g., the LIMIT
        // clause on MySQL).
        // Uncomment the block below to perform paging on a full result set.
        /*
         * return ((index_++ < count_) && (query_.getResultMap(rs_, this) != null)) ?
         * true : false;
         */
    }
