...
/**
 * Class that stores total size of all results. Intended for use with paged
 * searches where the items in the list are results for the current offset and
 * page. Allows a place to hold the total result set size.
 *
 * @author Doug Donohoe
 */
