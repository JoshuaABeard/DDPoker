...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Apr 24, 2008 Time: 9:04:07 AM
 * Bookmarkable paging navigator. Numbers pages starting at 1 so that bookmarked
 * links 'page=x' matches the display values to the user.
 */
public class BookmarkablePagingNavigator extends BoxPagingNavigator {
    ...
    public BookmarkablePagingNavigator(String id, CountPageable pageable, PluralLabelProvider itemName,
            Class<? extends Page> linkTo, PageParameters linkToParams, String pageParamName) {
        this(id, pageable, 3, true, itemName, linkTo, linkToParams, pageParamName);
    }

    public BookmarkablePagingNavigator(String id, CountPageable pageable, int padding, boolean showAnchors,
            PluralLabelProvider itemName, Class<? extends Page> linkTo, PageParameters linkToParams,
