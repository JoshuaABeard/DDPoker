...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Apr 23, 2008 Time: 2:58:51 PM
...
public class GroupingIntegerConverter extends AbstractIntegerConverter<Integer> {
    ...
    public Integer convertToObject(String value, Locale locale) {
        final Number number = parse(value, BigDecimal.valueOf(Integer.MIN_VALUE), BigDecimal.valueOf(Integer.MIN_VALUE),
                locale);
