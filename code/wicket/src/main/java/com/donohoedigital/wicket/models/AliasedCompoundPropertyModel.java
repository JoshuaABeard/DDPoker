...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Apr 28, 2008 Time: 9:18:29 AM
 *
 * Inspired by BoundCompoundPropertyModel, but aliases an id to an expression
 * instead of a component. Easier to use since you don't need to have a
 * component created when you make the alias.
 */
public class AliasedCompoundPropertyModel<T> extends CompoundPropertyModel<T> {
    ...
    /**
     * List of Aliases. Although a Map would be a more natural implementation here,
     * a List is much more compact in terms of space. Although it may take longer to
     * find a component alias in theory, in practice it's unlikely that any
     * AliasedCompoundPropertyModel will really have enough aliases to matter.
     */
     ...
     *            The id to bind
     * @param alias
     *            The alias (a property expression pointing to the property in this
     *            model)
