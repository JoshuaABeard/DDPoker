...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Apr 24, 2008 Time: 4:50:24 PM
...
public class WicketUtils {
    ...
    private static <T extends Enum<T>> T getEnumImpl(PageParameters params, String key, Class<?> eClass,
            T defaultValue) {
        if (eClass == null)
