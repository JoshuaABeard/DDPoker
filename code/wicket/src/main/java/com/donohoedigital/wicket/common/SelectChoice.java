...
/**
 * Based class for representing a select list choice. Represents a user-defined
 * type T and its display value.
 *
...
public abstract class SelectChoice<T extends Serializable> implements Serializable, Comparable<SelectChoice<T>> {
    ...
    /**
     * Return String version of key so
     * {@link org.apache.wicket.Component#getDefaultModelObjectAsString()} returns a
     * sensible value. Useful if storing the value in
     ...
     *             if the underlying key class does not implement Comparable
     */
    @SuppressWarnings({"unchecked"})
    public int compareTo(SelectChoice<T> o) {
        if (!(key instanceof Comparable)) {
            throw new UnsupportedOperationException(
                    "Cannot compare non-comparable object: " + key.getClass().getName());
        }
