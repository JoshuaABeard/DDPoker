...
/**
 * class to replace text that matches highlight with &lt;span
 * class=cssClass>highlight&lt;/span>
 */
public class HighlightLabel extends Label {
    ...
    private String getHighlightedText() {
        ...
        StringBuilder replacement = new StringBuilder().append("<span class=\"").append(cssClass).append("\">")
                .append("$0").append("</span>");
