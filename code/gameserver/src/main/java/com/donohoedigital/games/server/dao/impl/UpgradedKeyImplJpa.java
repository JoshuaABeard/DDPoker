...
public class UpgradedKeyImplJpa extends JpaBaseDao<UpgradedKey, Long> implements UpgradedKeyDao {
    ...
    public UpgradedKey getByKey(String sKey) {
        ...
        Query query = entityManager.createQuery("select u from UpgradedKey u " + "where u.licenseKey = :key");
    ...
    public List<UpgradedKey> getAll() {
        return entityManager.createQuery("select u from UpgradedKey u " + "order by u.count desc, u.modifyDate desc")
                .getResultList();
    }
}
