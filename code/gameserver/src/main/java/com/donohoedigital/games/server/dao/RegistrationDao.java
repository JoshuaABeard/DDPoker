...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Mar 13, 2008 Time: 10:38:30 AM
 * <p/>
 * Registration DAO
 */
public interface RegistrationDao extends BaseDao<Registration, Long> {
     ...
     */
    PagedList<Registration> getMatching(Integer count, int offset, int pagesize, String nameSearch, String emailSearch,
            String keySearch, String addressSearch);
    ...
    /**
     * Get suspect keys where number of non-duplicate registrations is greater and
     * or equal to the passed in minimum
     */
     ...
     * registration must be of type REGISTRATION and must not be a duplicate itself.
     * (if it is not, nthing is done and 0 is returned).
     */
