...
public class GameButton extends TypedHashMap {
    ...
    /**
     * return true if button definition matches the given button name (account for
     * optional colon:phase)
     */
    public static boolean isMatch(String sButtonDefinition, String sButtonName) {
        if (sButtonDefinition.equals(sButtonName) || sButtonDefinition.startsWith(sButtonName + DELIM)) {
            return true;
        }
