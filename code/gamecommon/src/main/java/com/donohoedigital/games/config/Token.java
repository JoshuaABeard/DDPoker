...
public class Token {
     ...
     */
    public GamePiece moveTo(GamePieceContainer newcontainer, int nMoves, boolean bReplaceLastAction,
    ...
    /**
     * Undo last move - move back to location identified in last action. Returns new
     * piece we belong to.
     */
    ...
    public String toString() {
        return (piece_ != null ? piece_.getName() : "Token, No GamePiece") + " # history: " + actionHistory_.size()
