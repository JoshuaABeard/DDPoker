...
public class Territories extends TreeMap {
     ...
     */
    public Territories(Areas areas, MapPoints allPoints, Element root, Namespace ns) throws ApplicationError {
    ...
    /**
     * Get array of territories to avoid using iters. Note: this array is not
     * updated if a Territory is added - but that shouldn't be the case in GAME
     * MODE. Returns new array each time.
     *
    ...
    /**
     * Used in game mode - creates paths which represent territory - used for
     * filling.
     */
    ...
    /**
     * Used in game mode - creates array of adjacent borders for each territory.
     */
