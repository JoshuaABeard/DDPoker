...
public class MapPoint {
     ...
     */
    public MapPoint(Element point, Namespace ns, String sAttrErrorDesc) throws ApplicationError {
    ...
    /**
     * Return true if passed in object is equal to this point (x==x, y==y) and
     * borders equal
     */
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MapPoint) {
            ...
            if (p.x_ == x_ && p.y_ == y_ && p.sType_.equals(sType_))
                return true;
    ...
    public void printXML(XMLWriter writer, int nIndent) {
        ...
        if (angle_ != null && !angle_.equals(NO_ANGLE))
            writer.printAttribute("angle", angle_);
        if (sType_ != null && !sType_.equals(NO_TYPE))
