...
public class EngineMessage extends DDMessage {
    ...
    public static final String PARAM_TO_PLAYER_ID = "tid"; // id of player message intended for (typically set in
                                                            // PlayerQueue)
    ...
    /**
     * Get seq id. Returns "-1" if not there (note that the starting seq ID, as set
     * from Game.java will always be 1
     */
