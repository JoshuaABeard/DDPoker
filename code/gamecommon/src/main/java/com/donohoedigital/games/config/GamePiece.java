...
public abstract class GamePiece implements Comparable {
    ...
    /**
     * Returns new Token(this). Here so can be overriden to provide subclass of
     * Token
     */
    ...
    /**
     * Get Displayable name of this piece. Lookup "gamepiece." + getName() in
     * PropertyConfig
     */
    ...
    /**
     * Get territory this piece is in (casts container to territory if appropriate).
    ...
    public String toString() {
        String sPlayer = "";
        if (player_ != null)
            sPlayer += player_.getName();
        return sName_ + " (" + nType_ + ") in " + container_ + " owner " + sPlayer;
    }

    /**
     * Two pieces are equal if the integer type, container and owner are the same
     */
    public boolean equals(Object o) {
        ...
        if (nType_.equals(gp.nType_) && container_ == gp.container_ && // == should work
    ...
    /**
     * Compares two pieces. Unequal pieces are ordered by type first. if type is
     * equal, pieces which are owned by the owner of a container are order first
     * (over pieces owned by "invaders". This is important because the compareTo
     * order dicates the order in which they are drawn.
     */
    public int compareTo(Object o) {
        ...
        if (player_ != null && gp.player_ != null && container_ != null && gp.container_ != null) {
    ...
    /**
     * Returns true if the owner of this piece is also the owner of the container in
     * which the piece resides
     */
    ...
    /**
     * Return this piece encoded as a game state entry. If bAdd is true, the entry
     * is added to the given GameState
     */
    ...
    /**
     * Return true if tokens should always be written out on a save. Defaults to
     * false, which means tokens are only written out when hasMovedTokens() is true
