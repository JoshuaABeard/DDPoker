...
public class Areas extends TreeMap {
     ...
     */
    public Areas(Element root, Namespace ns) throws ApplicationError {
    ...
    /**
     * Get array of areas to avoid using iters. Note: this array is not updated if
     * an Area is added - but that shouldn't be the case in GAME MODE. Returns new
     * array each time.
     *
