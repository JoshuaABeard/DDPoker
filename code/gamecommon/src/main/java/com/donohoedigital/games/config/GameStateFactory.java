...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Apr 5, 2008 Time: 8:22:15 AM To
...
public class GameStateFactory {
    ...
    public static GameState createGameState(String sName, String sBegin, String sExt, String sDesc) {
        try {
            Constructor<? extends GameState> c = getClazz().getConstructor(String.class, String.class, String.class,
                    String.class);
    ...
    public static GameState createGameState(String sName, File fDir, String sBegin, String sExt, String sDesc) {
        try {
            Constructor<? extends GameState> c = getClazz().getConstructor(String.class, File.class, String.class,
