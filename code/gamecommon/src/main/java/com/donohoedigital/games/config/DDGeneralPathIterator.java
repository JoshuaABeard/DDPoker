...
public class DDGeneralPathIterator implements PathIterator {
    ...
    /**
     * Copy results of path iterator here so we can reuse. Doubles data stored in
     * the path, but extra mem used is better than recreating the path over and over
     * and over considering it is used for contains() functionality for each path
     * for each mouse movement (adds up!)
     */
