...
public class GameStateEntry extends TokenizedList {
    ...
    /**
     * Create a new instance of GameStateEntry from a String, previously generated
     * with write(). This constructor does not parse all of the data - it only
     * parses the fields necessary to recreate the id/classname. Remaining tokens
     * can be parsed with the "finishParsing()" method.
     */
