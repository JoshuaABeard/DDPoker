...
public class Area {
     ...
     */
    public Area(Element area, String sAttrErrorDesc) throws ApplicationError {
    ...
    private static class AreaComparator implements Comparator {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof AreaComparator)
                return true;
            return false;
        }
    }
    ...
    /**
     * Get array of territories in this area - this area is created in
     * calculateStats. In non-game mode, null is returned. Note: no decorations are
     * ever in this list
     */
    ...
    /**
     * Create territory array of area contents out decorations
     */
    ...
    public void calculateStats() {
        ...
        for (int i = 0; i < ts.length; i++) {
            ...
            for (int j = 0; j < as.length; j++) {
                a = as[j];
                if (a.isDecoration() || a.getArea() == this)
                    continue;
