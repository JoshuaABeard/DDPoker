 ...
 */
public class OnlineProfileSummaryTest {
    ...
    public void testConstructor() {
        ...
        OnlineProfileSummary summary = new OnlineProfileSummary(name, count);
    ...
    public void testConstructorWithNullName() {
        OnlineProfileSummary summary = new OnlineProfileSummary(null, 10);
