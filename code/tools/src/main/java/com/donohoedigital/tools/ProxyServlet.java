...
public class ProxyServlet extends BaseServlet {
    ...
    public void afterConfigInit() {
        ...
        setSteps(new String[]{PropertyConfig.getMessage("msg.ddmessagelistener." + DDMessageListener.STEP_CONNECTING),
    ...
    /**
     * Setting DD Message Handler to false (above) means this is not called. But we
     * have to implement it anyhow. Data handled in ProxySocketThread.
     */
