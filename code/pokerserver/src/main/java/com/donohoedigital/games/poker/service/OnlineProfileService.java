...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Mar 18, 2008 Time: 1:37:55 PM
...
public interface OnlineProfileService {
    ...
    @Transactional(readOnly = true)
    List<OnlineProfile> getMatchingOnlineProfiles(Integer count, int offset, int pagesize, String nameSearch,
    ...
    /**
     * Hash a plaintext password using bcrypt and set it on the profile. This is the
     * primary method for setting passwords on profiles.
     *
     * @param profile
