...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Mar 14, 2008 Time: 10:54:59 PM
...
public interface TournamentHistoryDao extends BaseDao<TournamentHistory, Long> {
    ...
    TournamentHistoryList getAllForProfile(Integer count, int offset, int pagesize, Long id, String nameSearch,
            Date begin, Date end);

    int getLeaderboardCount(int games_limit, String nameSearch, Date begin, Date end);

    LeaderboardSummaryList getLeaderboard(Integer count, int offset, int pagesize, boolean sortByROI, int games_limit,
