...
class OnlineGameServiceTest
{
    ...
    {
        OnlineGameList games = service.getOnlineGames(null, 0, 10, new Integer[]{2}, null, null, null, OnlineGameService.OrderByType.date);
    ...
    void should_HandlePagination_When_GettingGames()
    {
        ...
        // Get first page
        OnlineGameList page1 = service.getOnlineGames(null, 0, 2, new Integer[]{2}, null, null, null, OnlineGameService.OrderByType.date);
        assertThat(page1).isNotNull();
        assertThat(page1.size()).isLessThanOrEqualTo(2);

        // Get second page
        OnlineGameList page2 = service.getOnlineGames(null, 2, 2, new Integer[]{2}, null, null, null, OnlineGameService.OrderByType.date);
    ...
    void should_FilterByMode_When_MultipleModesProvided()
    {
        ...
        int count = service.getOnlineGamesCount(new Integer[]{OnlineGame.MODE_PLAY, OnlineGame.MODE_REG}, null, null, null);
    ...
    void should_OrderByMode_When_OrderByModeSpecified()
    {
        ...
        OnlineGameList games = service.getOnlineGames(null, 0, 10, new Integer[]{2}, null, null, null, OnlineGameService.OrderByType.mode);
        assertThat(games).isNotNull();
    }
