...
public class GameServerException extends RuntimeException {
    ...
    public enum ErrorCode {
        GAME_NOT_FOUND, GAME_FULL, WRONG_PASSWORD, GAME_NOT_JOINABLE, GAME_NOT_OBSERVABLE, NOT_GAME_OWNER, WRONG_HOSTING_TYPE, GAME_ALREADY_STARTED, GAME_NOT_IN_LOBBY, PLAYER_NOT_FOUND, GAME_COMPLETED, NOT_APPLICABLE, INVALID_GAME_STATE
    }
