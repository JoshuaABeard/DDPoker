...
public class DrawingUtil implements KeyListener, MouseMotionListener, MouseListener {
    ...
    /**
     * Paint given point (assumes color set in g before call). x/y are scaled
     * correctly to current space
     */
    ...
    public void repaintPoint(MapPoint point) {
        ...
        Rectangle rect = new Rectangle(scaleToCurrentSpace(point.x_) - nPointSize,
                scaleToCurrentSpace(point.y_) - nPointSize, nPointSize * 2, nPointSize * 2);
    ...
    /**
     * Set flag to indicate whether mouse is inside this component and checks
     * whether shift is down (need to check since we wouldn't have gotten that key
     * event)
     */
