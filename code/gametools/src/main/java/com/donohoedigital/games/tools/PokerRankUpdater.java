...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Oct 21, 2005 Time: 1:11:41 PM
...
public class PokerRankUpdater extends BaseCommandLineApp {
    ...
    private void doRank(OnlineGame game) {
        ...
        logger.debug("id #" + game.getId() + ": " + game.getTournament().getName() + " hosted by "
                + game.getHostPlayer() + " with " + count + " total players");
