...
public class GameboardTerritoryManager extends GameManager implements CustomTerritoryDrawer {
     ...
     */
    public GameboardTerritoryManager(String sConfigName, String[] args) throws ApplicationError {
    ...
    public JComponent createScrollComponent() {
        ...
        // set to default size
        // board_.setNewSize(board_.getPreferredSize(new
        // Dimension(nDefaultSize,nDefaultSize)), false);
        ...
        // add actions for [ and ]
        GuiUtils.addKeyAction(board_, JComponent.WHEN_IN_FOCUSED_WINDOW, "decrease", new DecreaseSize(),
                KeyEvent.VK_OPEN_BRACKET, 0);
        GuiUtils.addKeyAction(board_, JComponent.WHEN_IN_FOCUSED_WINDOW, "increase", new IncreaseSize(),
    ...
    // "notdefined", false);
    // private String ARTILLERY =
    // PropertyConfig.getStringProperty("define.territoryPointType.artillery",
    // "notdefined", false);
    // private String CAVALRY =
    // PropertyConfig.getStringProperty("define.territoryPointType.cavalry",
    // "notdefined", false);
    // private String EXPLORER =
    // PropertyConfig.getStringProperty("define.territoryPointType.explorer",
    // "notdefined", false);
    // private String ENGINEER =
    // PropertyConfig.getStringProperty("define.territoryPointType.engineer",
    // "notdefined", false);
    // private String REDSHIP =
    // PropertyConfig.getStringProperty("define.territoryPointType.ship-red",
    // "notdefined", false);
    // private String PURPLESHIP =
    // PropertyConfig.getStringProperty("define.territoryPointType.ship-purple",
    // "notdefined", false);
    // private String GREENSHIP =
    // PropertyConfig.getStringProperty("define.territoryPointType.ship-green",
    // "notdefined", false);
    // private String BLUESHIP =
    // PropertyConfig.getStringProperty("define.territoryPointType.ship-blue",
    // "notdefined", false);
    // private String YELLOWSHIP =
    // PropertyConfig.getStringProperty("define.territoryPointType.ship-yellow",
    // "notdefined", false);
    // private String GRAYSHIP =
    // PropertyConfig.getStringProperty("define.territoryPointType.ship-gray",
    // "notdefined", false);
    // private String WHITESHIP =
    // PropertyConfig.getStringProperty("define.territoryPointType.ship-white",
    // "notdefined", false);
    // private String BLACKSHIP =
    // PropertyConfig.getStringProperty("define.territoryPointType.ship-black",
    // "notdefined", false);
    // private String LEADER =
    // PropertyConfig.getStringProperty("define.territoryPointType.leader",
    // "notdefined", false);
    // private String FORT =
    // PropertyConfig.getStringProperty("define.territoryPointType.fort",
    // "notdefined", false);
    // private String SCHOOL =
    // PropertyConfig.getStringProperty("define.territoryPointType.school",
    // "notdefined", false);
    // private String BUILDING =
    // PropertyConfig.getStringProperty("define.territoryPointType.building",
    // "notdefined", false);
    // private String RESOURCE =
    // PropertyConfig.getStringProperty("define.territoryPointType.resource",
    // "notdefined", false);
    // private String NATIVE =
    // PropertyConfig.getStringProperty("define.territoryPointType.native",
    // "notdefined", false);
    // private Double SCALE_MARKER = .9d; // must match resource piece getScale()
    // override
    ...
    private void drawItem(Gameboard board, Graphics2D g, Territory t, String sNAME, String sImageName, Double dScale,
            boolean bCenterAtBottom, int xadjust, int yadjust) {
