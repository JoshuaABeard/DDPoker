...
public class GameboardBorderManager extends GameManager {
     ...
     */
    public GameboardBorderManager(String sConfigName, String[] args) throws ApplicationError {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        switch (e.getKeyCode()) {
            ...
            case KeyEvent.VK_N :
                if (xhair_.isDrawing()) {
                    MouseEvent fake = new MouseEvent(xhair_, MouseEvent.MOUSE_RELEASED, 0, 0,
                            xhair_.getX() + xhair_.getWidth() / 2, xhair_.getY() + xhair_.getHeight() / 2, 1, false,
                            MouseEvent.BUTTON1);
