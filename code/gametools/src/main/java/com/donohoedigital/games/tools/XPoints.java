 ...
 * @author Doug Donohoe
 */
public class XPoints extends XConnectorLines implements KeyListener, DrawingUtilInterface {
     ...
     */
    public XPoints(GameboardBorderManager manager, GameboardConfig gameconfig, double dScaleFactor, boolean bNoImage) {
    ...
    public void processMouseClick(MouseEvent e) {
        ...
        // get index in array of selected point (returns -1 if none selected, i.e.,
        // borderPointSelected_==null)
        int nPoint = -1;
        if (borderPointHasFocus()) {
    ...
    private void delete(BorderPoint point) {
        ...
        // else get nearest point in border
            ...
            allPoints_.removeMapPoint(point);
            if (point == util_.pointAtMouse_)
                util_.pointAtMouse_ = null;
        }
    }
        ...
        switch (e.getKeyCode()) {
            ...
            case KeyEvent.VK_B :
                ...
                if (borderSelected_ != null) {
                    if (borderPointHasFocus()) {
                        Border newShared = manager_.chooseBorder(
                                "Add Shared Border to point " + borderPointSelected_.shortDesc(),
