...
public abstract class GameManager extends BaseApp implements KeyListener, StatusDisplay {
     ...
     */
    public GameManager(String sConfigName, String sTitle, String[] args) throws ApplicationError {
        ...
        try {
            if (bDoSave) {
                ...
                setStatus("Saved " + gameconfig_.getTerritories().size() + " territories, "
                        + gameconfig_.getBorders().size() + " borders, and " + gameconfig_.getMapPoints().size()
                        + " points: " + gameconfig_.getFile().getAbsolutePath());
            }
    ...
    protected void createUI() {
        ...
        pointer_.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(3, 0, 3, 0),
