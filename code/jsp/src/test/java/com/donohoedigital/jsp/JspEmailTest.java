...
class JspEmailTest {
    @Test
    void should_GenerateEmailContent_When_JSPExecuted() {
        ...
        assertThat(html).isEqualTo("HTML JSPEmail Unit Test");
        assertThat(plain).isEqualTo("PLAIN JSPEmail Unit Test");
        assertThat(subject).isEqualTo("Subject Test");
    }
}
