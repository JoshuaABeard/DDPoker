...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Mar 16, 2005 Time: 8:25:28 PM
...
public class DDScrollBarUI extends MetalScrollBarUI {
    ...
    /**
     * override to ensure buttons are around when configureScrollBarColors is called
     * (JDK1.5 change)
     */
    ...
    /**
     * Override to paint full thumb when no thumb needed. Moved to this method for
     * JDK1.5 (makes more sense here anyway).
     */
    ...
    /**
     * Copied verbatim from MetalScrollBarUI because they use static colors for
     * thumb, which is dumb
     */
    ...
    /**
     * create buttons early so they are around when we set colors (JDK1.5 change -
     * they changed order of creation)
     */
