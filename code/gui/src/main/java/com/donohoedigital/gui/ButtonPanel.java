...
public class ButtonPanel extends DDPanel implements MouseListener {
    ...
    protected javax.swing.border.Border bNormal_ = BorderFactory
            .createCompoundBorder(BorderFactory.createEtchedBorder(), BorderFactory.createEmptyBorder(0, 3, 0, 3));
    protected javax.swing.border.Border bMouseDown_ = BorderFactory.createCompoundBorder(
            BorderFactory.createLoweredBevelBorder(), BorderFactory.createEmptyBorder(0, 3, 0, 3));
    ...
    protected javax.swing.border.Border borderProtected_ = BorderFactory.createCompoundBorder(
            BorderFactory.createEmptyBorder(2, 2, 2, 2), BorderFactory.createEmptyBorder(0, 3, 0, 3));
    ...
    public ButtonPanel(String sName, String sStyle, boolean bTransparentBackground) {
        ...
        if (bTransparentBackground) {
            cNormalBGsave_ = cNormalBG_ = new Color(cNormalBG_.getRed(), cNormalBG_.getGreen(), cNormalBG_.getBlue(),
                    0);
    ...
    public void mouseEntered(MouseEvent e) {
        if (!isEnabled() || bDisplayOnly_ || bProtected_ || bSelected_)
            return;
    ...
    public void mousePressed(MouseEvent e) {
        if (!isEnabled() || bDisplayOnly_ || bProtected_)
            return;
    ...
    protected void fireActionPerformed() {
        ...
        for (int i = listeners.length - 2; i >= 0; i -= 2) {
            if (listeners[i] == ActionListener.class) {
                ...
                if (e == null) {
                    e = new ActionEvent(this, ActionEvent.ACTION_PERFORMED, null, 0, 0);
                }
