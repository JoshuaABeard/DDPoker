...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Jun 20, 2006 Time: 7:20:39 PM
...
public class DDSplitPane extends JSplitPane implements DDComponent {
    ...
    public DDSplitPane(String sName, String sStyle, int newOrientation, Component newLeftComponent,
