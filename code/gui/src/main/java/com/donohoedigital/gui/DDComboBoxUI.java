...
/**
 * Copied MetalComboBoxUI and made tweaks - for some reason subclassing
 * MetalComboBoxUI didn't really work. See JDD for changes (in source).
 *
 * @author Doug Donohoe
 */
public class DDComboBoxUI extends BasicComboBoxUI {
    ...
    protected JButton createArrowButton() {
        JButton button = new DDComboBoxButton((DDComboBox) comboBox, new DDComboBoxIcon(), comboBox.isEditable(),
    ...
    public Dimension getMinimumSize(JComponent c) {
        ...
        if (!comboBox.isEditable() && arrowButton != null && arrowButton instanceof DDComboBoxButton) {
