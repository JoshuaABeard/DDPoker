...
* @author  Doug Donohoe
*/
public class DDComboBox extends JComboBox implements DDTextVisibleComponent, DDExtendedComponent, DDListComponent {
    ...
    /**
     * return current selected value. If "notselected" value is chosen, this returns
     * null;
     */
    public Object getSelectedValue() {
        Object oValue = getSelectedItem();
        if (oValue == getNotSelectedValue())
            return null;
        return oValue;
    }

    /**
     * is valid? Returns true if an item is selected and this is required. If not
