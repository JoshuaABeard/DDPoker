...
/**
 * Copied MetalComboBoxButton code, but subclass DDButton instead and make other
 * UI tweaks
 *
 * @author Doug Donohoe
 */
public class DDComboBoxButton extends GlassButton {
    ...
    public DDComboBoxButton(DDComboBox cb, Icon i, CellRendererPane pane, JList list) {
        this();
        comboBox = cb;
        comboIcon = i;
        rendererPane = pane;
    ...
    public DDComboBoxButton(DDComboBox cb, Icon i, boolean onlyIcon, CellRendererPane pane, JList list) {
        this(cb, i, pane, list);
        iconOnly = onlyIcon;
    }

    /**
     * we don't get actual focus, we draw focus based on whether combo has focus
     */
