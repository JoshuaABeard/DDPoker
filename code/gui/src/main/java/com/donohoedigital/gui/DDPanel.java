...
public class DDPanel extends JPanel implements DDComponent {
    ...
    public void paintComponent(Graphics g1) {
        ...
        if (debug) {
            ...
            logger.debug("REPAINT COMPONENT " + (CNT++) + " (" + ImageComponent.getDebugColorName() + ") portion "
                    + bounds_.x + "," + bounds_.y + " " + bounds_.width + "x" + bounds_.height);
