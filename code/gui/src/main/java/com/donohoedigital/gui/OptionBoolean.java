...
public class OptionBoolean extends DDOption implements ActionListener, ChangeListener {
    ...
    public OptionBoolean(String sPrefNode, String sName, String sStyle, TypedHashMap map,
            boolean bPaintIconBackground) {
        this(sPrefNode, sName, sStyle, map, bPaintIconBackground, null);
    }

    /**
     * Creates a new instance of OptionBoolean. Extra option is added to EAST and
     * disabled when this checkbox is not selected
     */
    public OptionBoolean(String sPrefNode, String sName, String sStyle, TypedHashMap map, boolean bPaintIconBackground,
            DDOption extra) {
    ...
    public void stateChanged(ChangeEvent e) {
        if (extra_ != null)
            extra_.setEnabledEmbedded(box_.isSelected());
    }
