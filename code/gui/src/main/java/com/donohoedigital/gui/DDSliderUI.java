...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: May 22, 2005 Time: 5:34:49 PM
 *
...
public class DDSliderUI extends MetalSliderUI {
    ...
    public void paintTrack(Graphics g) {
        ...
        if (true) {
            ...
            if (slider.isEnabled()) {
                ...
                g.setColor(slider.getBackground());
                g.fillRect(fillLeft + 1, fillTop + 1, fillRight - fillLeft + 1, fillBottom - fillTop + 1);
            } else {
    ...
    private static class VerticalSlider implements Icon, Serializable, UIResource {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            // Draw the highlight
            if (slider.isEnabled()) {
                g.setColor(slider.getThumbBackgroundColor().brighter());// slider.hasFocus() ?
    ...
    private static class HorizontalSlider implements Icon, Serializable, UIResource {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            // }
            // else {
            // g.setColor( Color.blue );//slider.isEnabled() ?
