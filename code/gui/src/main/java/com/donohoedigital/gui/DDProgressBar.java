...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: May 25, 2005 Time: 8:50:29 PM
...
public class DDProgressBar extends DDPanel implements DDProgressFeedback, DDTextVisibleComponent {
    ...
    public void setBackground(Color bg) {
        ...
        if (label_ != null)
            label_.setBackground(bg);
        if (progress_ != null)
            progress_.setBackground(bg);
    }

    public void setForeground(Color fg) {
        super.setForeground(fg);
        if (label_ != null)
            label_.setForeground(fg);
        if (progress_ != null)
            progress_.setForeground(fg);
    }
