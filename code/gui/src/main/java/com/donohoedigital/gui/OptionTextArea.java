...
public class OptionTextArea extends DDOption implements PropertyChangeListener {
     ...
     */
    public OptionTextArea(String sPrefNode, String sName, String sStyle, String sBevelStyle, TypedHashMap map,
            int nLengthLimit, String sRegExp, int nRows, int nWidth) {
        ...
        if (sBevelStyle != null)
            text_.setBorder(BorderFactory.createEmptyBorder(2, 2, 2, 2));
