...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Jun 21, 2005 Time: 8:23:58 AM
 *
...
public class DDGridLayout implements LayoutManager {
     ...
     * values. Horizontal gaps are placed between each of the columns. Vertical gaps
     * are placed between each of the rows.
     * <p>
     * One, but not both, of <code>rows</code> and <code>cols</code> can be zero,
     * which means that any number of objects can be placed in a row or in a column.
     * <p>
     ...
     * vertical padding times the number of rows minus one, plus the top and bottom
