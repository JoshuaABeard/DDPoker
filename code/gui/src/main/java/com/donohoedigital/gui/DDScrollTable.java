...
public class DDScrollTable extends DDScrollPane {
    ...
    public DDScrollTable(String sName, String sStyle, String sBevelStyle, String[] columnnames, int[] columnwidths) {
        super(null, sStyle, sBevelStyle, DDScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
    ...
    /**
     * return preferred width of table, including scrollbar and border insets
     */
    public int getPreferredWidth() {
        int nWidth = getVerticalScrollBarPolicy() == JScrollPane.VERTICAL_SCROLLBAR_NEVER
                ? 0
    ...
    /**
     * our own class to tweak column header view due to our custom scrollbar. This
     * shifts headers over so the header gaps line up with the table lines; and
     * adjusts width to avoid a gray blank spot on the right of the header.
     */
