...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Mar 16, 2005 Time: 8:31:40 PM
...
public class DDScrollPane extends JScrollPane implements DDComponent {
    ...
    public DDScrollPane(Component view, String sStyle, String bevelStyle, int nVerticalPolicy, int nHorizPolicy) {
        ...
        if (bevelStyle != null) {
            setViewportBorder(BorderFactory.createCompoundBorder(emptyBorder,
    ...
    // {
    // System.out.println("setViewPosition called: " + Utils.formatExceptionText(new
    // Throwable()));
    //
