...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Apr 2, 2005 Time: 2:28:22 PM To
...
public class BasicSVG {
    ...
    public void addPath(String sFill, String sStroke, String sPath) {
        SVGPath sp = new SVGPath(Utils.getHtmlColor(sFill), Utils.getHtmlColor(sStroke),
    ...
    public void calculateBounds() {
        ...
        for (int i = 0; i < n; i++) {
            ...
            bounds_.setRect(Math.min(bounds_.getX(), b.getX()), Math.min(bounds_.getY(), b.getY()),
                    Math.max(bounds_.getWidth(), b.getMaxX()), Math.max(bounds_.getHeight(), b.getMaxY()));
        }
    }
