...
public class ScaleLayout implements LayoutManager2, Cloneable {
    ...
    public void addLayoutComponent(Component component, Object constraints) {
        if (constraints instanceof ScaleConstraints || constraints instanceof ScaleConstraintsFixed) {
        ...
        if (oC instanceof ScaleConstraints) {
            ...
            if (constraints.font != null) {
                ...
                if (fNew.getSize2D() != fOld.getSize2D()) {
                    // logger.debug("New font size for " + child.getName() + " is " + newSize + "
                    // old is " + fOld.getSize2D());
                    child.setFont(fNew);
                }
            }
    ...
    public static void layoutScaleConstraintsFixed(ScaleConstraintsFixed constraints, Component child, Container parent,
            Insets insets) {
        Dimension childSize = child.getPreferredSize();
        Dimension parentSize = parent.getSize();
