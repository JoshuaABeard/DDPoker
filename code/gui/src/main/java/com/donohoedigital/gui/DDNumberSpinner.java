 ...
 * @author Doug Donohoe
 */
public class DDNumberSpinner extends JPanel implements ActionListener, DDTextVisibleComponent, PropertyChangeListener {
    ...
    /**
     * Set value of text (and triggers property change, which sets nValue_)
     */
    ...
    public void addArrowActions(JComponent to) {
        GuiUtils.addKeyAction(to, JComponent.WHEN_FOCUSED, "scrollup", new ScrollUp(this), KeyEvent.VK_UP, 0);
        GuiUtils.addKeyAction(to, JComponent.WHEN_FOCUSED, "scrolldown", new ScrollDown(this), KeyEvent.VK_DOWN, 0);

        // crtl-arrow keys move all the way
        GuiUtils.addKeyAction(to, JComponent.WHEN_FOCUSED, "scrollupmax", new ScrollUpMax(this), KeyEvent.VK_UP,
                KeyEvent.CTRL_DOWN_MASK);
        GuiUtils.addKeyAction(to, JComponent.WHEN_FOCUSED, "scrolldownmax", new ScrollDownMax(this), KeyEvent.VK_DOWN,
                KeyEvent.CTRL_DOWN_MASK);
    }
    ...
    private static class ScrollUp extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            if (!spin.isEnabled() || !spin.isVisible())
                return;
