...
public class OptionText extends DDOption implements PropertyChangeListener {
    ...
    public OptionText(String sPrefNode, String sName, String sStyle, TypedHashMap map, int nLengthLimit, String sRegExp,
            int nWidth) {
     ...
     */
    public OptionText(String sPrefNode, String sName, String sStyle, TypedHashMap map, int nLengthLimit, String sRegExp,
            int nWidth, boolean bLabel) {
        this(sPrefNode, sName, sStyle, null, map, nLengthLimit, sRegExp, nWidth, bLabel);
    }

    public OptionText(String sPrefNode, String sName, String sStyle, String sBevelStyle, TypedHashMap map,
            int nLengthLimit, String sRegExp, int nWidth, boolean bLabel) {
        ...
        if (sRegExp != null)
            text_.setRegExp(sRegExp); // regexp validates after being set
        saveToMap();
    ...
    public void saveToMap() {
        // logger.debug("Setting map " + sName_ + " from text "+
        // text_.getText().trim());
