 ...
 * <p>
 * <img src="doc-files/HorizontalFlowLayout-1.gif" ALT="Graphic of Layout for
...
public class HorizontalFlowLayout implements LayoutManager, java.io.Serializable {
    ...
    /**
     * This value indicates that each subcomponents should be top-justified.
     *
     * @since JDK1.0
     */
    ...
    /**
     * This value indicates that each subcomponents should be bottom-justified.
     *
     * @since JDK1.0
     */
     ...
     * <ul>
     * <code>LEFT</code> <code>RIGHT</code> <code>CENTER</code> <code>LEADING</code>
     * <code>TRAILING</code>
     * </ul>
     *
     * @serial
    ...
    /**
     * Constructs a new <code>HorizontalFlowLayout</code> with a centered alignment
     ...
     * alignment and a default 5-unit horizontal and vertical gap. The value of the
     * alignment argument must be one of <code>HorizontalFlowLayout.LEFT</code>,
     * <code>HorizontalFlowLayout.RIGHT</code>, or
     ...
     *            the vertical gap between components
     * @param subalign
     *            the alignment of components within this (TOP/CENTER/BOTTOM)
     */
    ...
    /**
     * Gets the sub-alignment for this layout. Possible values are
     * <code>HorizontalFlowLayout.TOP</code>,
     * <code>HorizontalFlowLayout.BOTTOM</code>, or
     * <code>HorizontalFlowLayout.CENTER</code>.
     *
    ...
    /**
     * Sets the sub-alignment for this layout. Possible values are
     * <code>HorizontalFlowLayout.TOP</code>,
     * <code>HorizontalFlowLayout.BOTTOM</code>, and
     * <code>HorizontalFlowLayout.CENTER</code>.
     *
     * @param subAlign
     *            the sub-alignment value.
        ...
        synchronized (target.getTreeLock()) {
            ...
            for (int i = rowStart; i < rowEnd; i++) {
                ...
                if (m.isVisible()) {
                    ...
                    // } else {
                    // m.setLocation(target.getWidth() - x - m.getWidth(), y + (height -
                    // m.getHeight()) / 2);
                    // }
                    // x += m.getWidth() + hgap;
                    int dy;
     ...
     * the alignment of this <code>HorizontalFlowLayout</code> object.
     *
     * @param target
