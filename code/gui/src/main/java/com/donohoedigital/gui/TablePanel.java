...
/**
 * Initial effort at a common panel for laying out aligned components in a
 * table. Currently supports label/text field pairs and is extendable for adding
 * other components. Future implementation should include support for more
 * components (see extended classes for examples).
 */
public class TablePanel extends DDPanel {
     ...
     */
    public TextWidgets addTextField(String labelName, String textName, String style, int length, String value,
            String regExp, Insets insets) {
