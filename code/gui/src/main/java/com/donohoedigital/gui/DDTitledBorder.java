...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: Mar 23, 2005 Time: 7:52:29 AM
 * To change this template use File | Settings | File Templates.
 */
public class DDTitledBorder extends TitledBorder {
    public DDTitledBorder(Border border, String title, int titleJustification, int titlePosition, Font titleFont,
            Color titleColor) {
