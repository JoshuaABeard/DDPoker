...
public class OptionRadio extends DDOption implements ActionListener, ChangeListener {
     ...
     */
    public OptionRadio(String sPrefNode, String sOptionName, String sStyle, TypedHashMap map, String sRadioName,
            ButtonGroup group, int nValue) {
        this(sPrefNode, sOptionName, sStyle, map, sRadioName, group, nValue, null);
    }

    /**
     * Creates a new instance of OptionRadio. Extra option is added to EAST and
     * disabled when this radio is not selected
     */
    public OptionRadio(String sPrefNode, String sOptionName, String sStyle, TypedHashMap map, String sRadioName,
            ButtonGroup group, int nValue, DDOption extra) {
    ...
    public void stateChanged(ChangeEvent e) {
        if (extra_ != null)
            extra_.setEnabledEmbedded(radio_.isSelected());
    }
