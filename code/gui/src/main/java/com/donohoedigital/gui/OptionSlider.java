...
public class OptionSlider extends DDOption implements ChangeListener {
     ...
     */
    public OptionSlider(String sPrefNode, String sName, String sStyle, TypedHashMap map, Integer nDefaultOverride,
        ...
        slider_.setValue(
                nDefaultOverride != null ? nDefaultOverride.intValue() : prefs_.getInt(sName_, nDefault_.intValue()));
