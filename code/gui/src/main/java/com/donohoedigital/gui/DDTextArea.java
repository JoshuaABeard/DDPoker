 ...
 * @author Doug Donohoe
 */
public class DDTextArea extends JTextArea
        implements
    ...
    public void keyReleased(KeyEvent e) {
        if (!keypressed)
            return; // ignore spurious released events if we didn't see the press
        ...
        if (pattern_ != null) {
            ...
            if (m.matches()) {
                ...
                if (current != bgNormal_) {
                    ...
                    if (scroll_ != null)
                        scroll_.setBackground(bgNormal_);
                    repaint();
                }
            } else {
                bValid_ = false;
                if (current != bgError_) {
                    ...
                    if (scroll_ != null)
                        scroll_.setBackground(bgError_);
                    repaint();
                }
            }
