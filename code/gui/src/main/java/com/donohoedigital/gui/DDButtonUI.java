...
public class DDButtonUI extends MetalButtonUI {
    ...
    static BasicStroke FOCUS_STROKE = new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 1.0f,
            new float[]{1.0f, 1.0f}, 0.0f);

    protected void paintFocus(Graphics g1, AbstractButton b, Rectangle viewRect, Rectangle textRect,
            Rectangle iconRect) {
        ...
        g.drawRect((focusRect.x - xgap), (focusRect.y - ygap), focusRect.width + (xgap * 2) - 1,
                focusRect.height + (ygap));
        g.setStroke(old);
    }
    ...
    private boolean drawBackgroundImage(Graphics g, DDButton button) {
        ...
        if (img != null) {
            ...
            if (drawwidth > img.getWidth(null))
                drawwidth = img.getWidth(null);
            if (drawheight > img.getHeight(null))
                drawheight = img.getHeight(null);
            g.drawImage(img, 0, 0, button.getWidth(), button.getHeight(), 0, 0, drawwidth, drawheight, button);
    ...
    protected void paintText(Graphics g1, JComponent c, Rectangle textRect, String text) {
        ...
        if (model.isEnabled()) {
            BasicGraphicsUtils.drawStringUnderlineCharAt(g, text, mnemIndex, textRect.x + nOffset,
    ...
    protected BasicButtonListener createButtonListener(AbstractButton b) {
        ...
        if (b instanceof DDImageButton)
            return new DDBasicButtonListener((DDImageButton) b);
    ...
    public class DDBasicButtonListener extends BasicButtonListener {
        ...
        public void mousePressed(MouseEvent e) {
            if (!button.isTransparentIgnored()) {
            ...
            if (!isMouseOverVisible(e))
                return;
            if (TESTING)
                GuiUtils.log("" + isMouseOverVisible(e) + ":" + button.getName() + " mousePressed()",
                        e.toString()/*
        ...
        public void mouseReleased(MouseEvent e) {
            ...
            if (TESTING)
                GuiUtils.log("" + isMouseOverVisible(e) + ":" + button.getName() + " mouseReleased()", e.toString());
            super.mouseReleased(e);
        }
        ...
        public void mouseEntered(MouseEvent e) {
            ...
            bMouseOver = true;
            if (TESTING)
                GuiUtils.log("" + isMouseOverVisible(e) + ":" + button.getName() + " mouseEntered()", e.toString());
            super.mouseEntered(e);
        }
        ...
        public void mouseExited(MouseEvent e) {
            ...
            bMouseOver = false;
            if (TESTING)
                GuiUtils.log("" + isMouseOverVisible(e) + ":" + button.getName() + " mouseExited()", e.toString());
            super.mouseExited(e);
        }
        ...
        public void mouseMoved(MouseEvent e) {
            ...
            if (TESTING)
                GuiUtils.log("" + isMouseOverVisible(e) + ":" + button.getName() + " mouseMoved()", e.toString());
            super.mouseMoved(e);
        };
        ...
        public void mouseDragged(MouseEvent e) {
            ...
            if (TESTING)
                GuiUtils.log("" + isMouseOverVisible(e) + ":" + button.getName() + " mouseDragged()", e.toString());
            super.mouseDragged(e);
        };
