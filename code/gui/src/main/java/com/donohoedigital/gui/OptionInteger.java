...
public class OptionInteger extends DDOption implements ChangeListener {
     ...
     */
    public OptionInteger(String sPrefNode, String sName, String sStyle, TypedHashMap map, Integer nDefaultOverride,
    ...
    public OptionInteger(String sPrefNode, String sName, String sStyle, TypedHashMap map, Integer nDefaultOverride,
        ...
        if (nWidth > 0)
            spinner_.setPreferredSize(new Dimension(nWidth, pref.height - 4));
        spinner_.setValue(nDefaultOverride != null ? nDefaultOverride : prefs_.getInt(sName_, nDefault_));
