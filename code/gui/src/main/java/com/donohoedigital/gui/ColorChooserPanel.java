...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: May 19, 2005 Time: 10:25:25 AM
...
public class ColorChooserPanel extends DDPanel {
    ...
    private void createUI(String sTile) {
        ...
        sample.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5),
    ...
    public boolean isValidData() {
        return red_.isValidData() && green_.isValidData() && blue_.isValidData() && alpha_.isValidData();
    }
