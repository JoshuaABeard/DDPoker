...
public class DDSpinner extends JSpinner implements DDTextVisibleComponent {
    ...
    private void fixBordersAndStuff() {
        ...
        for (int i = 0; i < children.length; i++) {
            ...
            if (children[i] instanceof JButton) { // this doesn't seem to do anything - must be do to UI
                ...
                if (child instanceof JTextComponent) {
                    ((JTextComponent) child)
                            .setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(0, 0, 0, 1),
