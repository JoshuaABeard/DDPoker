...
public abstract class DDOption extends DDPanel implements MouseListener {
    ...
    /**
     * Creates a new instance of DDOption. If sPrefNode is null, then a DummyPref is
     * used, which is useful if one wants to use the option widgets without saving
     * to prefs (i.e. for layout)
     */
    public DDOption(String sPrefNode, String sName, String sStyle, TypedHashMap map) {
        sName_ = sName;
        sOrigName_ = sName;
        STYLE = sStyle;
    ...
    /**
     * Are the contents of the option currently valid? Returns true by default
     */
    ...
    public void mouseEntered(MouseEvent e) {
        ...
        sbHelp.append(".help");
        String sHelp = PropertyConfig.getStringProperty(sbHelp.toString(), null, false);
