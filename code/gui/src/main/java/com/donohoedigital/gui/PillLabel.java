...
/**
 * Created by IntelliJ IDEA. User: donohoe Date: May 4, 2005 Time: 9:44:00 AM To
...
public class PillLabel extends DDLabel implements PillColors {
    ...
    protected void paintBackground(Graphics2D g) {
        // paint beveled area
        RoundRectangle2D rr = new RoundRectangle2D.Double(0, 0, getWidth() - 1, getHeight() - 1, getHeight() - 1,
                getHeight() - 1);
