...
public class DDLabelBorder extends JPanel implements DDHasLabelComponent {
    ...
    /**
     * Adjust border layout. Will throw ClassCastException if this panel is using
     * another layout
     */
    ...
    private void init(String sName, String sStyle) {
        ...
        border_ = new DDTitledBorder(border, sText_, TitledBorder.LEFT, TitledBorder.TOP, getFont(), getForeground());
        setBorder(border_);
    }
    ...
    public void setEnabled(boolean b) {
        // set disabled color
        if (b)
            border_.setTitleColor(getForeground());
        else
            border_.setTitleColor(GuiUtils.COLOR_DISABLED_TEXT);
