...
public class Peer2PeerClient {
    ...
    static {
        ...
        // DNSTIMEOUT =
        // PropertyConfig.getRequiredIntegerProperty("settings.http.dnstimeout.millis");
     ...
     */
    public Peer2PeerClient(P2PURL url, Peer2PeerMessageListener plistener, DDMessageListener listener) {
     ...
     */
    public Peer2PeerClient(String sIP, int nPort, Peer2PeerMessageListener plistener, DDMessageListener listener) {
        this(sIP, nPort, plistener, listener, null);
    }

    /**
     * Creates a new instance of Peer2PeerClient, passing in an existing socket to
     * use
     */
    public Peer2PeerClient(String sIP, int nPort, Peer2PeerMessageListener plistener, DDMessageListener listener,
            SocketChannel sc) {
     ...
     * initialize
     */
    private void init(String sIP, int nPort, Peer2PeerMessageListener plistener, DDMessageListener listener,
            SocketChannel sc) {
        try {
            listener_ = listener;
    ...
    public Peer2PeerMessage sendGetReply(Peer2PeerMessage msg) throws IOException {
        ...
        if (plistener_ != null)
            plistener_.messageReceived(reply);
        return reply;
    }
