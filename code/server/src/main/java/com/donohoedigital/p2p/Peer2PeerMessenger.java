...
public class Peer2PeerMessenger {
    ...
    /**
     * Send the p2p message to the given destination. If bWaitReply is true, then
     * the underlying Peer2PeerClient will wait for a reply after sending that reply
     * will be returned. If it is false, then the message is sent and null is
     * returned.
     */
