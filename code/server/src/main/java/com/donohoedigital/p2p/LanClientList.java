...
public class LanClientList {
    ...
    /**
     * Process received message. Caller ensures that the message received is valid.
     */
    ...
    /**
     * remove entries that have not been updated in given seconds, issue a
     * LAN_TIMEOUT for the key
     */
    ...
    /**
     * Return this list as an Array List sorted by given data field (constant in
     * LanClientInfo) and whether ascending or not
     */
