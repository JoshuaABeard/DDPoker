...
public class ServletDebug {
    ...
    public static void debugGet(HttpServletRequest httpservletrequest, HttpServletResponse httpservletresponse) {
        ...
        if (bVerbose_) {
            ...
            println("GETTING host: " + httpservletrequest.getServerName() + ":" + httpservletrequest.getServerPort());
    ...
    public static String getParams(HttpServletRequest httpservletrequest, boolean bIgnoreSessionIds) {
        ...
        if (names != null) {
            ...
            while (names.hasMoreElements()) {
                ...
                if (bIgnoreSessionIds && (sName.equals("sessionID") || sName.equals("RequisiteSession"))) {
                    continue;
                }
    ...
    public static String constructURL(HttpServletRequest httpservletrequest) {
        ...
        /*
         * String sPost = httpservletrequest.getReaderData(); if (sPost != null &&
         * sPost.length() > 0) { sb.append(POST_DELIMITER); sb.append(sPost);
