...
public class GameServletResponse implements HttpServletResponse {
    ...
    /**
     * calling this begins the response and then returns output stream for writing
     * data
     */
    ...
    /**
     * calling returns output stream for writing data (it doesn't call
     * beginReponse(), but it does configure proper blocking)
     */
    ...
    private void beginResponse(int responseCode, String sInfo) throws IOException {
        ...
        if (sContentType_ != null)
            sb.append("Content-Type: ").append(sContentType_).append('\n');
        sb.append('\n');
        out_.write(Utils.encodeBasic(sb.toString()));
    }
