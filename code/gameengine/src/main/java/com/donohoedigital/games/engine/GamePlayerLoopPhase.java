...
public class GamePlayerLoopPhase extends BasePhase {
    ...
    /**
     * Return index of player we are processing. Current implementation returns
     * nCurrentIndex + 1
     */
    ...
    /**
     * Called to see if done looping. Default implementation returns true when
     * nCurrentIndex is greater than/equal to the player count
     */
    ...
    /**
     * Called to get params to pass to loop phase Returns null (designed to be
     * overriden);
     */
    ...
    /**
     * Called to get params to pass to next phase. Returns null (designed to be
     * overriden);
     */
