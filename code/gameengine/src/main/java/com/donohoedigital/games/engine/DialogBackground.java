...
public class DialogBackground extends DDPanel {
     ...
     */
    public DialogBackground(GameContext context, GamePhase gamephase, Phase phase, boolean bNoShowOption,
    ...
    /**
     * Return panel holding buttons - can use to put something in any area besides
     * BorderLayout.CENTER
     */
