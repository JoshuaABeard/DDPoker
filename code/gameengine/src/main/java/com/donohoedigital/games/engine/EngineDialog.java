...
public class EngineDialog extends InternalDialog {
    ...
    public void init(GamePhase gamephase, String sTitle, boolean bResizable) {
        ImageIcon winicon = ImageConfig
                .getImageIcon(gamephase.getString("dialog-windowtitle-image", "dialog-windowtitle-image"));
        ...
        if (!Utils.ISMAC) {
            GuiUtils.addKeyAction(base_, JComponent.WHEN_IN_FOCUSED_WINDOW, "gameengineclose", close, KeyEvent.VK_W,
