 ...
 * @author Doug Donohoe
 */
public class Help extends BasePhase implements ListSelectionListener, HyperlinkListener, ActionListener {
    ...
    // save game info
    private static final int[] COLUMN_WIDTHS = new int[]{175};
    private static final String[] COLUMN_NAMES = new String[]{"helptopic"};
    ...
    public void hyperlinkUpdate(HyperlinkEvent e) {
        ...
        if (!displayHelpTopic(sName)) {
            if (sName.startsWith("http")) {
                ...
                // displayHelp(Utils.fixHtmlTextFor15(PropertyConfig.getMessage("msg.helptopic.http",
                // sName, sURL)));
    ...
    private void displaySelectedHelpTopic() {
        ...
        if (selected_.getScrollPosition() != null) {
            ...
            SwingUtilities.invokeLater(new Runnable() {
                public void run() {
                    // logger.debug(selected_.getName() + " scrollRectToVisible: "+
                    // selected_.getScrollPosition());
