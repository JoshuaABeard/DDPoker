...
/**
 * Class to show a message. It first calls getMessage() - this is used to enable
 * subclasses. If that returns null, it looks for a "msgkey" param, which it
 * looks up in the PropertyConfig. If there is no message key, it looks for a
 * "msg" param and displays that.
 *
 * @author Doug Donohoe
 */
