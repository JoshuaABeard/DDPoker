...
public class TerritoryComponent extends DDPanel {
    ...
    /**
     * Draw territory the piece belongs to, scaled to size of this component
     */
    public void drawTerritory(Territory t, Graphics2D g) {
        ...
        int BUFFER = 10;
        double dScale = Math.min((width - BUFFER) / pathbounds.getWidth(), (height - BUFFER) / pathbounds.getHeight());
        ...
        g.translate(-pathbounds.x + (adjustx / dScale), -pathbounds.y + (adjusty / dScale));
        ...
        if (bImageDrawn_ && board_ != null) {
            ...
            // draw image
            g.drawImage(image, (int) (pathbounds.x), (int) (pathbounds.y), pathbounds.x + pathbounds.width,
                    pathbounds.y + pathbounds.height, srcx, srcy, srcx2, srcy2, this);
        ...
        BasicStroke borderStroke = new BasicStroke((float) (1.0d / dScale), BasicStroke.CAP_BUTT,
