...
public class EnginePrefs {
    ...
    public boolean getBooleanOption(String prefName) {
        return prefs_.getBoolean(prefName, PropertyConfig.getRequiredBooleanProperty(DDOption.GetDefaultKey(prefName)));
    }
    ...
    public String getStringOption(String prefName) {
        return prefs_.get(prefName, PropertyConfig.getRequiredStringProperty(DDOption.GetDefaultKey(prefName)));
    }
    ...
    public int getIntOption(String prefName) {
        return prefs_.getInt(prefName, PropertyConfig.getRequiredIntegerProperty(DDOption.GetDefaultKey(prefName)));
    }
