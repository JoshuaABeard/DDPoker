    ...
    private void setComponentBounds(Container parent, Component child, Insets insets) {
        try {
            ...
            if (child instanceof ScrollGameboard) {
                ...
                // System.out.println("GAMEBOARDCENTER resized to: " + newsize + " based on " +
                // container.getSize() + " " + container.getName());
            ...
            if (child.getX() != componentLeft || child.getY() != componentTop || child.getWidth() != size.width
