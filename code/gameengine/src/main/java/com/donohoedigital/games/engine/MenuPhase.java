...
public class MenuPhase extends BasePhase {
    ...
    /**
     * add buttons to panel. By default uses values in gamedef to determine where to
     * add it (menubox-orientation) and creates a ButtonBox in that orientation.
     */
    ...
    public void start() {
        ...
        context_.setMainUIComponent(this, menu_, false,
                buttonbox_ != null ? (JComponent) buttonbox_.getDefaultButton() : menu_);
    }
