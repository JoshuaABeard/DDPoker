...
public class EngineGamePieceComponent extends JComponent {
    ...
    public void drawImage(Graphics2D g) {
        ...
        if (bScaleToSize_) {
            dScale_ = Math.min((width - IN) / imagewidth, (height - IN) / imageheight);
        }
        ...
        piece_.drawImageAt(g, ic, (nQuantityToDisplay_ == null) ? piece_.getQuantity() : nQuantityToDisplay_.intValue(),
                0, (nQuantityToDisplay_ == null) ? 1 : nQuantityToDisplay_.intValue(), x, y, imagewidth, imageheight,
                dLabelScale_);
