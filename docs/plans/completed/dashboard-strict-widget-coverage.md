...
- Add contract mapping notes to `docs/guides/local-features-strict-coverage-matrix.md`.
...
- `docs/guides/local-features-test-plan.md`
- `docs/guides/local-features-strict-coverage-matrix.md`
