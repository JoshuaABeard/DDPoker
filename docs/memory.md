...
- [architecture] poker module has zero dependency on pokergamecore — all game logic is server-side. Maven Enforcer bans pokergamecore. (2026-03-05)
...
- [architecture] Shared types (BettingRound, ActionType, TableState, PlayerAction, GamePlayerInfo, HandInfoFast, GameEvent system, PureTournamentClock) live in pokerengine (engine.state, engine.event packages). (2026-03-05)
